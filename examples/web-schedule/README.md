...
This overlay opts one `toh web` process into Schedule reminders without changing the shipped default Web composition:

```sh
toh web --patch examples/web-schedule/cordis.yml
```
