...
const REPOSITORY_URL = 'https://github.com/dustinwloring1988/theopen-harness'
...
function githubTarget(
  ...
  if (image) return `https://raw.githubusercontent.com/dustinwloring1988/theopen-harness/${repositoryRef}/${path}${suffix}`
