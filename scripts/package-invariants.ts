...
function checkManifest(
  ...
  if (owner.packageName === '@buckeyestudio/toh-invariants') return
  if (manifest.peerDependencies?.['@buckeyestudio/toh-invariants'] !== 'workspace:^') {
    addViolation(
      violations,
      owner.manifestPath,
      '@buckeyestudio/toh-invariants must be a workspace:^ peerDependency',
    )
  }
  if (manifest.devDependencies?.['@buckeyestudio/toh-invariants'] !== 'workspace:^') {
    addViolation(
      violations,
      owner.manifestPath,
      '@buckeyestudio/toh-invariants must also be a workspace:^ devDependency',
    )
  }
}
...
function checkBuild(
  ...
  if (owner.packageName !== '@buckeyestudio/toh-invariants'
