...
import {
  ...
  REGION_BEGIN,
  REGION_END,
} from '@buckeyestudio/toh-typert-generator'
import type { CordisCatalogPolicy } from '@buckeyestudio/toh-typert-generator'
 ...
 * The scan that enforces this list reads EVERY `declare module '@buckeyestudio/cordis'`
...
export const SERVICE_WALK_EXEMPTIONS: Record<string, string> = {
  ...
  tohHomePath: 'not a service: boot-provided root accessor function (typeof tohHomePath | undefined) for Loader !!js config expressions — packages/boot/app-boot/README.md owns the boot contract',
 ...
 * scan reads EVERY `declare module '@buckeyestudio/cordis'` Events merge under
