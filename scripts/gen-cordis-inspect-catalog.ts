...
import type { CordisCatalogModel, ServiceMethodEntry } from '@buckeyestudio/toh-typert-generator'
...
function main(): void {
  ...
  const source = projector.renderRuntimeApi(clientModel(model))
    .replaceAll('@buckeyestudio/toh-tool-cordis/api-catalog', '@buckeyestudio/toh-cordis-client-runner/client/api-catalog')
