...
| --- | --- | --- | --- |
| `@buckeyestudio/cosmokit` | `cosmokit` | [github.com/theopen-harness/cosmokit](https://github.com/theopen-harness/cosmokit) | MIT |
| `@buckeyestudio/schemastery` | `schemastery` | [github.com/theopen-harness/schemastery](https://github.com/theopen-harness/schemastery) | MIT |
| `@buckeyestudio/cordis` | `cordis` | [github.com/cordiverse/cordis](https://github.com/cordiverse/cordis) | MIT |
| `@buckeyestudio/cordis-plugin-loader` | `@cordisjs/plugin-loader` | [github.com/cordiverse/cordis](https://github.com/cordiverse/cordis) | MIT |
| `@buckeyestudio/cordis-plugin-include` | `@cordisjs/plugin-include` | [github.com/theopen-harness/cordis](https://github.com/theopen-harness/cordis) | MIT |
| `@buckeyestudio/cordis-plugin-group` | `@cordisjs/plugin-group` | [github.com/theopen-harness/cordis](https://github.com/theopen-harness/cordis) | MIT |
| `@buckeyestudio/cordis-plugin-timer` | `@cordisjs/plugin-timer` | [github.com/theopen-harness/cordis](https://github.com/theopen-harness/cordis) | MIT |
| `@buckeyestudio/cordis-plugin-hmr` | `@cordisjs/plugin-hmr` | [github.com/theopen-harness/cordis](https://github.com/theopen-harness/cordis) | MIT |
| `@buckeyestudio/cordis-plugin-logger-console` | `@cordisjs/plugin-logger-console` | [github.com/theopen-harness/cordis](https://github.com/theopen-harness/cordis) | MIT |
...
`eslint-plugin-sonarjs` (LGPL-3.0-only) and `lightningcss` (MPL-2.0) run only as development tooling; their code is not linked into or distributed with any TheOpen Harness artifact.
...
| [`pydantic`](https://github.com/pydantic/pydantic) | MIT | runtime dependency of `theopen-harness-sdk` |
