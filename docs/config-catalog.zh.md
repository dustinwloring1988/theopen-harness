...
<a id="buckeyestudiotoh-acp"></a>

## `@buckeyestudio/toh-acp`
...
<a id="buckeyestudiotoh-acp-demo"></a>

## `@buckeyestudio/toh-acp-demo`
...
export interface Config {
  ...
  persona?: string
  /** Explicit model-facing tool order (the system-prompt plugin's `toolOrder` config; see toh-system-prompt). */
  toolOrder?: string[]
  /** Tool-registry config — its presentation `mode` (forwarded through agent-spine-demo; see toh-tools). */
  tools?: ToolsConfig
  /** TheOpen Harness home directory exposed to bash and used for local skill discovery. */
  tohHome?: string
...
依赖：[`agentCore`](../packages/examples/agent-spine-demo/src/index.ts) · [`JsonlCompression`](../packages/session/session-persistence-jsonl/src/index.ts) · [`ToolsConfig`](#buckeyestudiotoh-tools)

来源：[`packages/examples/acp-demo/src/index.ts:39`](../packages/examples/acp-demo/src/index.ts)

<a id="buckeyestudiotoh-agent-default-model"></a>

## `@buckeyestudio/toh-agent-default-model`
...
<a id="buckeyestudiotoh-agent-instructions"></a>

## `@buckeyestudio/toh-agent-instructions`

```ts config-catalog
/** User-facing workspace instruction loader configuration. */
export interface Config {
  /** Harness home containing the fixed user-global `AGENTS.md`; defaults to `$TOH_HOME` or `~/.toh`. */
  tohHome?: string
...
<a id="buckeyestudiotoh-agent-loop"></a>

## `@buckeyestudio/toh-agent-loop`
...
<a id="buckeyestudiotoh-agent-presets"></a>

## `@buckeyestudio/toh-agent-presets`
...
<a id="buckeyestudiotoh-agent-spine-demo"></a>

## `@buckeyestudio/toh-agent-spine-demo`
 ...
 * `tohHome` to bash environment and local skill discovery, `sessionTitle` to
 ...
 */
export interface Config {
  /** The agent-loop `agents` list (see toh-agent-loop's `Config`). */
  ...
  /** The deployment persona (see toh-system-prompt's `Config`). */
  persona?: SystemPromptConfig['persona']
  /** The explicit model-facing tool order (see toh-system-prompt's `Config`). */
  toolOrder?: SystemPromptConfig['toolOrder']
  /** The tool registry's config — its presentation `mode` (see toh-tools' `Config`). */
  tools?: ToolsConfig
  /** TheOpen Harness home directory shared by shell context and local skill discovery. */
  tohHome?: string
...
依赖：[`AgentLoopConfig`](#buckeyestudiotoh-agent-loop) · [`GoalDomainConfig`](#buckeyestudiotoh-goal) · [`InvariantConfig`](#buckeyestudiotoh-invariants) · [`JobsConfig`](#buckeyestudiotoh-jobs-local) · [`SessionTitleConfig`](#buckeyestudiotoh-session-title) · [`SkillFileSystem`](../packages/skill/skill-filesystem/src/index.ts) · [`SkillRegistryConfig`](#buckeyestudiotoh-skill) · [`SystemPromptConfig`](#buckeyestudiotoh-system-prompt) · [`toolBash`](../packages/shell/tool-bash/src/index.ts) · [`toolGoal`](../packages/goal/tool-goal/src/index.ts) · [`toolJobs`](../packages/jobs/tool-jobs/src/index.ts) · [`ToolsConfig`](#buckeyestudiotoh-tools) · [`toolSkill`](../packages/skill/tool-skill/src/index.ts) · [`workspaceContext`](../packages/context/agent-instructions/src/index.ts)

来源：[`packages/examples/agent-spine-demo/src/index.ts:92`](../packages/examples/agent-spine-demo/src/index.ts)

<a id="buckeyestudiotoh-agent-tool-presentation"></a>

## `@buckeyestudio/toh-agent-tool-presentation`
...
<a id="buckeyestudiotoh-attachment-local"></a>

## `@buckeyestudio/toh-attachment-local`

```ts config-catalog
/** Local attachment backend configuration. */
export interface Config {
  /** Explicit harness home; omitted follows `TOH_HOME`, then `~/.toh`. */
  tohHome?: string
...
<a id="buckeyestudiotoh-bash-sandbox"></a>

## `@buckeyestudio/toh-bash-sandbox`
...
依赖：[`LocalConfig`](#buckeyestudiotoh-bash-local)

来源：[`packages/shell/bash-sandbox/src/index.ts:35`](../packages/shell/bash-sandbox/src/index.ts)

<a id="buckeyestudiotoh-client-connection"></a>

## `@buckeyestudio/toh-client-connection`
...
export interface ConnectionConfig {
   ...
   * by (the toh CLI derives the machine's LAN IP literals itself). An entry
...
<a id="buckeyestudiotoh-client-hmr"></a>
...
<a id="buckeyestudiotoh-code-runtime-worker-thread"></a>

## `@buckeyestudio/toh-code-runtime-worker-thread`
...
<a id="buckeyestudiotoh-compaction-basic"></a>

## `@buckeyestudio/toh-compaction-basic`
...
<a id="buckeyestudiotoh-compaction-tool-result-pruner"></a>

## `@buckeyestudio/toh-compaction-tool-result-pruner`
...
<a id="buckeyestudiotoh-cordis-host-runner"></a>

## `@buckeyestudio/toh-cordis-host-runner`
...
<a id="buckeyestudiotoh-credentials-local"></a>

## `@buckeyestudio/toh-credentials-local`
...
export interface Config {
  ...
  path?: string
  /** Harness home used when `path` is omitted; defaults to `$TOH_HOME` or `~/.toh`. */
  tohHome?: string
...
<a id="buckeyestudiotoh-e2b"></a>

## `@buckeyestudio/toh-e2b`
...
<a id="buckeyestudiotoh-experimental-agent-team"></a>

## `@buckeyestudio/toh-experimental-agent-team`
...
<a id="buckeyestudiotoh-experimental-tool-agent-team"></a>

## `@buckeyestudio/toh-experimental-tool-agent-team`
...
<a id="buckeyestudiotoh-file-reference-local"></a>
...
<a id="buckeyestudiotoh-fs-local"></a>

## `@buckeyestudio/toh-fs-local`
...
<a id="buckeyestudiotoh-fs-sandbox"></a>

## `@buckeyestudio/toh-fs-sandbox`
...
依赖：[`LocalConfig`](#buckeyestudiotoh-fs-local)

来源：[`packages/fs/fs-sandbox/src/index.ts:49`](../packages/fs/fs-sandbox/src/index.ts)

<a id="buckeyestudiotoh-goal"></a>

## `@buckeyestudio/toh-goal`
...
<a id="buckeyestudiotoh-headless"></a>

## `@buckeyestudio/toh-headless`
...
<a id="buckeyestudiotoh-hooks-claude-code"></a>

## `@buckeyestudio/toh-hooks-claude-code`
...
<a id="buckeyestudiotoh-hooks-codex"></a>

## `@buckeyestudio/toh-hooks-codex`
...
<a id="buckeyestudiotoh-host-apiproxy"></a>

## `@buckeyestudio/toh-host-apiproxy`
...
<a id="buckeyestudiotoh-host-directory-picker-browse"></a>

## `@buckeyestudio/toh-host-directory-picker-browse`
...
<a id="buckeyestudiotoh-host-frontend-static"></a>

## `@buckeyestudio/toh-host-frontend-static`
...
<a id="buckeyestudiotoh-invariants"></a>

## `@buckeyestudio/toh-invariants`
...
<a id="buckeyestudiotoh-jobs-local"></a>

## `@buckeyestudio/toh-jobs-local`
...
<a id="buckeyestudiotoh-llm-deepseek"></a>

## `@buckeyestudio/toh-llm-deepseek`
...
<a id="buckeyestudiotoh-llm-pi-ai"></a>

## `@buckeyestudio/toh-llm-pi-ai`
...
<a id="buckeyestudiotoh-llm-replay"></a>

## `@buckeyestudio/toh-llm-replay`

需要：`llm`

```ts config-catalog
/** Plugin config: the {@link ReplayConfig} inputs, each defaulting to its `TOH_SNAPSHOT_*` env var in `apply`. */
export interface Config {
  /** Override the fixture path; defaults to `$TOH_SNAPSHOT_FILE`. */
  file?: string
  /** Override the sidecar path; defaults to `$TOH_SNAPSHOT_OVERRIDE`. */
  overrideFile?: string
  /**
   * Override the child-log paths; defaults to `$TOH_SNAPSHOT_CHILD_FILES` (a
...
<a id="buckeyestudiotoh-llm-retry"></a>

## `@buckeyestudio/toh-llm-retry`
...
<a id="buckeyestudiotoh-lsp-stdio"></a>

## `@buckeyestudio/toh-lsp-stdio`
...
<a id="buckeyestudiotoh-mcp-client"></a>
...
<a id="buckeyestudiotoh-permission-presets"></a>

## `@buckeyestudio/toh-permission-presets`
...
<a id="buckeyestudiotoh-persona"></a>

## `@buckeyestudio/toh-persona`
...
<a id="buckeyestudiotoh-plan-mode"></a>

## `@buckeyestudio/toh-plan-mode`
...
<a id="buckeyestudiotoh-pwsh-local"></a>

## `@buckeyestudio/toh-pwsh-local`
...
<a id="buckeyestudiotoh-pwsh-sandbox"></a>

## `@buckeyestudio/toh-pwsh-sandbox`
...
依赖：[`LocalConfig`](#buckeyestudiotoh-pwsh-local)

来源：[`packages/shell/pwsh-sandbox/src/index.ts:40`](../packages/shell/pwsh-sandbox/src/index.ts)

<a id="buckeyestudiotoh-repeat-tool-reminder"></a>

## `@buckeyestudio/toh-repeat-tool-reminder`
...
## `@buckeyestudio/toh-sandbox-local`
...
<a id="buckeyestudiotoh-sandbox-policy"></a>

## `@buckeyestudio/toh-sandbox-policy`
...
<a id="buckeyestudiotoh-sdk-jsonrpc-server"></a>

## `@buckeyestudio/toh-sdk-jsonrpc-server`
...
<a id="buckeyestudiotoh-session-persistence-jsonl"></a>

## `@buckeyestudio/toh-session-persistence-jsonl`
...
## `@buckeyestudio/toh-session-persistence-sqlite`
...
<a id="buckeyestudiotoh-session-projection-cache"></a>

## `@buckeyestudio/toh-session-projection-cache`
...
<a id="buckeyestudiotoh-session-query-sqlite"></a>

## `@buckeyestudio/toh-session-query-sqlite`
...
## `@buckeyestudio/toh-session-reference`
...
<a id="buckeyestudiotoh-session-telemetry-otel"></a>

## `@buckeyestudio/toh-session-telemetry-otel`
 ...
 * and one TOH-owned shutdown bound. Uploading modes validate their endpoint
...
<a id="buckeyestudiotoh-session-title"></a>
...
## `@buckeyestudio/toh-settings-file`
...
<a id="buckeyestudiotoh-shell-env"></a>
...
export interface Config {
  /** TheOpen Harness home directory exposed as `TOH_HOME`; defaults to `$TOH_HOME` or `~/.toh`. */
  tohHome?: string
}
```
...
<a id="buckeyestudiotoh-skill"></a>

## `@buckeyestudio/toh-skill`
...
<a id="buckeyestudiotoh-skill-filesystem"></a>

## `@buckeyestudio/toh-skill-filesystem`
...
export interface Config {
  ...
  /** TheOpen Harness config root. Defaults to `$TOH_HOME` or `~/.toh`. */
  tohHome?: string
  /** Shared agent config root. Defaults to `$TOH_AGENTS_HOME` or `~/.agents`. */
  agentsHome?: string
  ...
  /** Bundled skill root; defaults to `$TOH_BUNDLED_SKILL_DIR` when default roots are included, otherwise mounts none. */
...
<a id="buckeyestudiotoh-spill-local"></a>

## `@buckeyestudio/toh-spill-local`
...
<a id="buckeyestudiotoh-spill-policy"></a>

## `@buckeyestudio/toh-spill-policy`
...
<a id="buckeyestudiotoh-storage-domain"></a>

## `@buckeyestudio/toh-storage-domain`
...
<a id="buckeyestudiotoh-storage-json"></a>

## `@buckeyestudio/toh-storage-json`
...
<a id="buckeyestudiotoh-storage-sqlite"></a>

## `@buckeyestudio/toh-storage-sqlite`
...
<a id="buckeyestudiotoh-subagent-acp"></a>

## `@buckeyestudio/toh-subagent-acp`
...
<a id="buckeyestudiotoh-subagent-claude-code"></a>

## `@buckeyestudio/toh-subagent-claude-code`
...
<a id="buckeyestudiotoh-subagent-codex"></a>

## `@buckeyestudio/toh-subagent-codex`
...
<a id="buckeyestudiotoh-subagent-toh-sdk"></a>

## `@buckeyestudio/toh-subagent-fork-in-process`
...
<a id="buckeyestudiotoh-subagent-spawn-in-process"></a>

## `@buckeyestudio/toh-subagent-spawn-in-process`
...
<a id="buckeyestudiotoh-subprocess-e2b"></a>

## `@buckeyestudio/toh-subagent-toh-sdk`
...
export interface Config {
  /** Provider name on `ctx.subagents` (default `toh-sdk`). */
  providerName: string
  ...
  /**
   * Extra environment variables for the child process — e.g. the child
   * runtime's own `DEEPSEEK_API_KEY`, or `TOH_CORDIS_CONFIG` naming its
...
来源：[`packages/subagent/subagent-toh-sdk/src/index.ts:29`](../packages/subagent/subagent-toh-sdk/src/index.ts)

<a id="buckeyestudiotoh-subagent-fork-in-process"></a>

## `@buckeyestudio/toh-subprocess-e2b`
...
<a id="buckeyestudiotoh-system-prompt"></a>

## `@buckeyestudio/toh-system-prompt`

```ts config-catalog
/** Plugin config: the deployment-authored fragment of the system prompt (see {@link Config.persona} for its contract). */
export interface Config {
  /** Include the fixed TheOpen Harness identity before the deployment persona (default true). */
...
<a id="buckeyestudiotoh-terminal-bash"></a>

## `@buckeyestudio/toh-terminal-bash`
...
<a id="buckeyestudiotoh-time-context"></a>

## `@buckeyestudio/toh-time-context`
...
<a id="buckeyestudiotoh-tmux-context"></a>

## `@buckeyestudio/toh-tmux-context`
...
<a id="buckeyestudiotoh-token-meter"></a>
...
<a id="buckeyestudiotoh-tool-bash"></a>

## `@buckeyestudio/toh-tool-bash`
...
<a id="buckeyestudiotoh-tool-bash-persistent"></a>

## `@buckeyestudio/toh-tool-bash-persistent`
...
<a id="buckeyestudiotoh-tool-fs"></a>

## `@buckeyestudio/toh-tool-fs`
...
<a id="buckeyestudiotoh-tool-fs-search"></a>

## `@buckeyestudio/toh-tool-fs-search`
...
export interface Config {
   ...
   * `@buckeyestudio/toh-tool-call-timeout-policy` through `exec.signal`.
   */
  timeoutMs?: number
}
```
...
<a id="buckeyestudiotoh-tool-goal"></a>

## `@buckeyestudio/toh-tool-goal`
...
<a id="buckeyestudiotoh-tool-jobs"></a>

## `@buckeyestudio/toh-tool-jobs`
...
<a id="buckeyestudiotoh-tool-lsp"></a>

## `@buckeyestudio/toh-tool-lsp`
...
<a id="buckeyestudiotoh-tool-pwsh-persistent"></a>

## `@buckeyestudio/toh-tool-pwsh-persistent`
...
<a id="buckeyestudiotoh-tool-ralph"></a>

## `@buckeyestudio/toh-tool-ralph`
...
<a id="buckeyestudiotoh-tool-session-query"></a>

## `@buckeyestudio/toh-tool-session-query`
...
<a id="buckeyestudiotoh-tool-str-replace-editor"></a>

## `@buckeyestudio/toh-tool-str-replace-editor`
...
<a id="buckeyestudiotoh-tool-subagent"></a>

## `@buckeyestudio/toh-tool-subagent`
...
<a id="buckeyestudiotoh-tool-subagent-report"></a>

## `@buckeyestudio/toh-tool-subagent-report`
...
<a id="buckeyestudiotoh-tool-terminal"></a>

## `@buckeyestudio/toh-tool-terminal`
...
<a id="buckeyestudiotoh-tool-todo"></a>

## `@buckeyestudio/toh-tool-todo`
...
<a id="buckeyestudiotoh-tool-web"></a>

## `@buckeyestudio/toh-tool-web`
...
<a id="buckeyestudiotoh-tool-workflow"></a>

## `@buckeyestudio/toh-tool-workflow`
...
<a id="buckeyestudiotoh-tools"></a>

## `@buckeyestudio/toh-tools`
...
<a id="buckeyestudiotoh-user-approval"></a>

## `@buckeyestudio/toh-user-approval`
...
<a id="buckeyestudiotoh-web"></a>

## `@buckeyestudio/toh-web`
...
<a id="buckeyestudiotoh-web-app"></a>

## `@buckeyestudio/toh-web-app`
...
export interface Config {
   ...
   * section and the `TOH_WEB_URL` bash variable). A one-shot non-interactive
...
<a id="buckeyestudiotoh-web-fetch-http"></a>
...
## `@buckeyestudio/toh-web-search-deepseek`
...
<a id="buckeyestudiotoh-web-search-exa"></a>

## `@buckeyestudio/toh-web-search-exa`
...
<a id="buckeyestudiotoh-web-search-perplexity"></a>

## `@buckeyestudio/toh-web-search-perplexity`
...
<a id="buckeyestudiotoh-workflow-worker-thread"></a>

## `@buckeyestudio/toh-workflow-worker-thread`
...
- `@buckeyestudio/toh-agent`（[`packages/core/agent/src/index.ts`](../packages/core/agent/src/index.ts)）
- `@buckeyestudio/toh-api-gateway` — 需要 `typert`（[`packages/api/gateway/src/index.ts`](../packages/api/gateway/src/index.ts)）
- `@buckeyestudio/toh-api-remotes`（[`packages/api/remotes/src/index.ts`](../packages/api/remotes/src/index.ts)）
- `@buckeyestudio/toh-authorization` — 需要 `credentials`（[`packages/credentials/authorization/src/index.ts`](../packages/credentials/authorization/src/index.ts)）
- `@buckeyestudio/toh-client-locale`（[`packages/client/locale/src/index.ts`](../packages/client/locale/src/index.ts)）
- `@buckeyestudio/toh-client-modules` — 需要 `webServer` · `loader`（[`packages/client/modules/src/index.ts`](../packages/client/modules/src/index.ts)）
- `@buckeyestudio/toh-client-runtime`（[`packages/client/runtime/src/index.ts`](../packages/client/runtime/src/index.ts)）
- `@buckeyestudio/toh-client-ui-agent-preset`（[`packages/client/ui-agent-preset/src/index.ts`](../packages/client/ui-agent-preset/src/index.ts)）
- `@buckeyestudio/toh-client-ui-attachment`（[`packages/client/ui-attachment/src/index.ts`](../packages/client/ui-attachment/src/index.ts)）
- `@buckeyestudio/toh-client-ui-brand-official`（[`packages/client/ui-brand-official/src/index.ts`](../packages/client/ui-brand-official/src/index.ts)）
- `@buckeyestudio/toh-client-ui-commands`（[`packages/client/ui-commands/src/index.ts`](../packages/client/ui-commands/src/index.ts)）
- `@buckeyestudio/toh-client-ui-conversation`（[`packages/client/ui-conversation/src/index.ts`](../packages/client/ui-conversation/src/index.ts)）
- `@buckeyestudio/toh-client-ui-cordis`（[`packages/extensions/ui-cordis/src/index.ts`](../packages/extensions/ui-cordis/src/index.ts)）
- `@buckeyestudio/toh-client-ui-deliverables` — 需要 `systemPrompt`（[`packages/client/ui-deliverables/src/index.ts`](../packages/client/ui-deliverables/src/index.ts)）
- `@buckeyestudio/toh-client-ui-directory-picker-browse`（[`packages/client/ui-directory-picker-browse/src/index.ts`](../packages/client/ui-directory-picker-browse/src/index.ts)）
- `@buckeyestudio/toh-client-ui-directory-picker-native`（[`packages/client/ui-directory-picker-native/src/index.ts`](../packages/client/ui-directory-picker-native/src/index.ts)）
- `@buckeyestudio/toh-client-ui-goal`（[`packages/client/ui-goal/src/index.ts`](../packages/client/ui-goal/src/index.ts)）
- `@buckeyestudio/toh-client-ui-input-trigger`（[`packages/client/ui-input-trigger/src/index.ts`](../packages/client/ui-input-trigger/src/index.ts)）
- `@buckeyestudio/toh-client-ui-jobs`（[`packages/client/ui-jobs/src/index.ts`](../packages/client/ui-jobs/src/index.ts)）
...
- `@buckeyestudio/toh-client-ui-renderer`（[`packages/client/ui-renderer/src/index.ts`](../packages/client/ui-renderer/src/index.ts)）
- `@buckeyestudio/toh-client-ui-settings`（[`packages/client/ui-settings/src/index.ts`](../packages/client/ui-settings/src/index.ts)）
- `@buckeyestudio/toh-client-ui-settings-general`（[`packages/client/ui-settings-general/src/index.ts`](../packages/client/ui-settings-general/src/index.ts)）
- `@buckeyestudio/toh-client-ui-settings-models`（[`packages/client/ui-settings-models/src/index.ts`](../packages/client/ui-settings-models/src/index.ts)）
- `@buckeyestudio/toh-client-ui-settings-plugin-inventory`（[`packages/client/ui-settings-plugin-inventory/src/index.ts`](../packages/client/ui-settings-plugin-inventory/src/index.ts)）
- `@buckeyestudio/toh-client-ui-settings-plugins`（[`packages/client/ui-settings-plugins/src/index.ts`](../packages/client/ui-settings-plugins/src/index.ts)）
- `@buckeyestudio/toh-client-ui-sidebar`（[`packages/client/ui-sidebar/src/index.ts`](../packages/client/ui-sidebar/src/index.ts)）
- `@buckeyestudio/toh-client-ui-skill`（[`packages/client/ui-skill/src/index.ts`](../packages/client/ui-skill/src/index.ts)）
- `@buckeyestudio/toh-client-ui-subagent`（[`packages/client/ui-subagent/src/index.ts`](../packages/client/ui-subagent/src/index.ts)）
- `@buckeyestudio/toh-client-ui-theme`（[`packages/client/ui-theme/src/index.ts`](../packages/client/ui-theme/src/index.ts)）
- `@buckeyestudio/toh-client-ui-tool`（[`packages/client/ui-tool/src/index.ts`](../packages/client/ui-tool/src/index.ts)）
- `@buckeyestudio/toh-client-ui-trajectory`（[`packages/client/ui-trajectory/src/index.ts`](../packages/client/ui-trajectory/src/index.ts)）
- `@buckeyestudio/toh-client-ui-user-questions`（[`packages/client/ui-user-questions/src/index.ts`](../packages/client/ui-user-questions/src/index.ts)）
- `@buckeyestudio/toh-client-ui-workflow-run`（[`packages/client/ui-workflow-run/src/index.ts`](../packages/client/ui-workflow-run/src/index.ts)）
- `@buckeyestudio/toh-client-ui-workspace`（[`packages/client/ui-workspace/src/index.ts`](../packages/client/ui-workspace/src/index.ts)）
- `@buckeyestudio/toh-command-compact` — 需要 `commands` · `compact`（[`packages/compaction/command-compact/src/index.ts`](../packages/compaction/command-compact/src/index.ts)）
- `@buckeyestudio/toh-command-feedback` — 需要 `commands`（[`packages/feedback/command-feedback/src/index.ts`](../packages/feedback/command-feedback/src/index.ts)）
- `@buckeyestudio/toh-command-goal` — 需要 `commands` · `goals`（[`packages/goal/command-goal/src/index.ts`](../packages/goal/command-goal/src/index.ts)）
- `@buckeyestudio/toh-commands`（[`packages/interaction/commands/src/index.ts`](../packages/interaction/commands/src/index.ts)）
- `@buckeyestudio/toh-cordis-client-runner`（[`packages/extensions/cordis-client-runner/src/index.ts`](../packages/extensions/cordis-client-runner/src/index.ts)）
- `@buckeyestudio/toh-fs-e2b` — 需要 `e2b`（[`packages/e2b/fs-e2b/src/index.ts`](../packages/e2b/fs-e2b/src/index.ts)）
- `@buckeyestudio/toh-fs-observation-policy`（[`packages/fs/fs-observation-policy/src/index.ts`](../packages/fs/fs-observation-policy/src/index.ts)）
- `@buckeyestudio/toh-goal-round-driver` — 需要 `agents` · `goals` · `sessions`（[`packages/goal/goal-round-driver/src/index.ts`](../packages/goal/goal-round-driver/src/index.ts)）
- `@buckeyestudio/toh-host-directory-picker-auto` — 需要 `webServer` · `loader`（[`packages/host/directory-picker-auto/src/index.ts`](../packages/host/directory-picker-auto/src/index.ts)）
- `@buckeyestudio/toh-host-directory-picker-native`（[`packages/host/directory-picker-native/src/index.ts`](../packages/host/directory-picker-native/src/index.ts)）
- `@buckeyestudio/toh-host-plugin-inventory` — 需要 `loader`（[`packages/host/plugin-inventory/src/index.ts`](../packages/host/plugin-inventory/src/index.ts)）
- `@buckeyestudio/toh-llm`（[`packages/llm/llm/src/index.ts`](../packages/llm/llm/src/index.ts)）
- `@buckeyestudio/toh-lsp`（[`packages/lsp/lsp/src/index.ts`](../packages/lsp/lsp/src/index.ts)）
- `@buckeyestudio/toh-schedule` — 需要 `agents` · `sessions` · `tools` · `sessionPersistence`（[`packages/schedule/schedule/src/index.ts`](../packages/schedule/schedule/src/index.ts)）
- `@buckeyestudio/toh-session`（[`packages/core/session/src/index.ts`](../packages/core/session/src/index.ts)）
- `@buckeyestudio/toh-session-checkpoint-policy` — 需要 `llm` · `sessionPersistence` · `sessions` · `tools`（[`packages/session/session-checkpoint-policy/src/index.ts`](../packages/session/session-checkpoint-policy/src/index.ts)）
- `@buckeyestudio/toh-session-log-export` — 需要 `commands`（[`packages/session-query/session-log-export/src/index.ts`](../packages/session-query/session-log-export/src/index.ts)）
- `@buckeyestudio/toh-session-projection`（[`packages/session/session-projection/src/index.ts`](../packages/session/session-projection/src/index.ts)）
- `@buckeyestudio/toh-session-stats` — 需要 `sessionProjections`（[`packages/session/session-stats/src/index.ts`](../packages/session/session-stats/src/index.ts)）
- `@buckeyestudio/toh-skill-badge` — 需要 `skills`（[`packages/skill/skill-badge/src/index.ts`](../packages/skill/skill-badge/src/index.ts)）
- `@buckeyestudio/toh-storage`（[`packages/storage/storage/src/index.ts`](../packages/storage/storage/src/index.ts)）
- `@buckeyestudio/toh-subagent`（[`packages/subagent/subagent/src/index.ts`](../packages/subagent/subagent/src/index.ts)）
- `@buckeyestudio/toh-subprocess-local`（[`packages/subprocess/subprocess-local/src/index.ts`](../packages/subprocess/subprocess-local/src/index.ts)）
- `@buckeyestudio/toh-terminal`（[`packages/terminal/terminal/src/index.ts`](../packages/terminal/terminal/src/index.ts)）
- `@buckeyestudio/toh-tool-ask-user` — 需要 `tools` · `userInteraction`（[`packages/interaction/tool-ask-user/src/index.ts`](../packages/interaction/tool-ask-user/src/index.ts)）
- `@buckeyestudio/toh-tool-call-timeout-policy` — 需要 `tools`（[`packages/guard/timeout-policy/src/index.ts`](../packages/guard/timeout-policy/src/index.ts)）
- `@buckeyestudio/toh-tool-cordis` — 需要 `tools` · `systemPrompt` · `dynamicCordisRunner` · `cordisInspect`（[`packages/extensions/tool-cordis/src/index.ts`](../packages/extensions/tool-cordis/src/index.ts)）
- `@buckeyestudio/toh-tool-subagent-control` — 需要 `tools` · `subagents`（[`packages/subagent/tool-subagent-control/src/index.ts`](../packages/subagent/tool-subagent-control/src/index.ts)）
- `@buckeyestudio/toh-user-questions`（[`packages/interaction/user-questions/src/index.ts`](../packages/interaction/user-questions/src/index.ts)）
- `@buckeyestudio/toh-workspace` — 需要 `storageDomain` · `sessionPersistence`（[`packages/workspace/workspace/src/index.ts`](../packages/workspace/workspace/src/index.ts)）

## Seam 包（不可直接加载）

抽象服务类——部署时应改为加载具体的实现包（参见[能力 seam](../.agents/notes/implemented/architecture/2026-06-13-capability-seams.zh.md)）。

- `@buckeyestudio/toh-attachment` — 抽象 `AttachmentStore`（[`packages/attachment/attachment/src/index.ts`](../packages/attachment/attachment/src/index.ts)）
- `@buckeyestudio/toh-code-runtime` — 抽象 `CodeRuntime`（[`packages/code-runtime/code-runtime/src/index.ts`](../packages/code-runtime/code-runtime/src/index.ts)）
- `@buckeyestudio/toh-compaction` — 抽象 `CompactionEngine`（[`packages/compaction/compaction/src/index.ts`](../packages/compaction/compaction/src/index.ts)）
- `@buckeyestudio/toh-credentials` — 抽象 `Credentials`（[`packages/credentials/credentials/src/index.ts`](../packages/credentials/credentials/src/index.ts)）
- `@buckeyestudio/toh-file-reference` — 抽象 `FileReferenceService`（[`packages/context/file-reference/src/index.ts`](../packages/context/file-reference/src/index.ts)）
- `@buckeyestudio/toh-fs` — 抽象 `FileSystem`（[`packages/fs/fs/src/index.ts`](../packages/fs/fs/src/index.ts)）
- `@buckeyestudio/toh-host-directory-picker` — 抽象 `DirectoryPicker`（[`packages/host/directory-picker/src/index.ts`](../packages/host/directory-picker/src/index.ts)）
- `@buckeyestudio/toh-jobs` — 抽象 `JobRegistry`（[`packages/jobs/jobs/src/index.ts`](../packages/jobs/jobs/src/index.ts)）
- `@buckeyestudio/toh-sandbox` — 抽象 `SandboxProvider`（[`packages/sandbox/sandbox/src/index.ts`](../packages/sandbox/sandbox/src/index.ts)）
- `@buckeyestudio/toh-session-persistence` — 抽象 `SessionPersistence`（[`packages/session/session-persistence/src/index.ts`](../packages/session/session-persistence/src/index.ts)）
- `@buckeyestudio/toh-session-query` — 抽象 `SessionQueryEngine`（[`packages/session-query/session-query/src/index.ts`](../packages/session-query/session-query/src/index.ts)）
- `@buckeyestudio/toh-settings` — 抽象 `Settings`（[`packages/settings/settings/src/index.ts`](../packages/settings/settings/src/index.ts)）
- `@buckeyestudio/toh-shell` — 抽象 `ShellExecutor`（[`packages/shell/shell/src/index.ts`](../packages/shell/shell/src/index.ts)）
- `@buckeyestudio/toh-spill` — 抽象 `SpillStore`（[`packages/spill/spill/src/index.ts`](../packages/spill/spill/src/index.ts)）
- `@buckeyestudio/toh-subprocess` — 抽象 `SubprocessRuntime`（[`packages/subprocess/subprocess/src/index.ts`](../packages/subprocess/subprocess/src/index.ts)）
- `@buckeyestudio/toh-workflow` — 抽象 `WorkflowEngine`（[`packages/workflow/workflow/src/index.ts`](../packages/workflow/workflow/src/index.ts)）
## 库包（无插件入口）

由其他包作为库导入；`cordis.yml` 无法加载它们。

- `@buckeyestudio/toh-acp-snapshot`（[`packages/test-support/acp-snapshot/src/index.ts`](../packages/test-support/acp-snapshot/src/index.ts)）
- `@buckeyestudio/toh-agent-loop-testkit`（[`packages/test-support/agent-loop-testkit/src/index.ts`](../packages/test-support/agent-loop-testkit/src/index.ts)）
- `@buckeyestudio/toh-anonymous-user-id`（[`packages/identity/anonymous-user-id/src/index.ts`](../packages/identity/anonymous-user-id/src/index.ts)）
- `@buckeyestudio/toh-app-boot`（[`packages/boot/app-boot/src/index.ts`](../packages/boot/app-boot/src/index.ts)）
- `@buckeyestudio/toh-atomic-write`（[`packages/util/atomic-write/src/index.ts`](../packages/util/atomic-write/src/index.ts)）
- `@buckeyestudio/toh-base`（[`packages/bundle/base/src/index.ts`](../packages/bundle/base/src/index.ts)）
- `@buckeyestudio/toh-brand`（[`packages/util/brand/src/index.ts`](../packages/util/brand/src/index.ts)）
- `@buckeyestudio/toh-client-test-runtime`（[`packages/test-support/client-runtime/src/index.ts`](../packages/test-support/client-runtime/src/index.ts)）
- `@buckeyestudio/toh-client-ui-primitives`（[`packages/client/ui-primitives/src/index.ts`](../packages/client/ui-primitives/src/index.ts)）
- `@buckeyestudio/toh-client-ui-slots`（[`packages/client/ui-slots/src/index.ts`](../packages/client/ui-slots/src/index.ts)）
- `@buckeyestudio/toh-client-web`（[`packages/client/web/src/index.ts`](../packages/client/web/src/index.ts)）
- `@buckeyestudio/toh-cmdline`（[`packages/boot/cmdline/src/index.ts`](../packages/boot/cmdline/src/index.ts)）
- `@buckeyestudio/toh-code-runtime-python`（[`packages/code-runtime/code-runtime-python/src/index.ts`](../packages/code-runtime/code-runtime-python/src/index.ts)）
- `@buckeyestudio/toh-home-paths`（[`packages/util/home-paths/src/index.ts`](../packages/util/home-paths/src/index.ts)）
- `@buckeyestudio/toh-hook-protocol`（[`packages/hooks/hook-protocol/src/index.ts`](../packages/hooks/hook-protocol/src/index.ts)）
- `@buckeyestudio/toh-launch-environment`（[`packages/util/launch-environment/src/index.ts`](../packages/util/launch-environment/src/index.ts)）
- `@buckeyestudio/toh-llm-mock-server`（[`packages/test-support/llm-mock-server/src/index.ts`](../packages/test-support/llm-mock-server/src/index.ts)）
- `@buckeyestudio/toh-loader-smoke`（[`packages/test-support/loader-smoke/src/index.ts`](../packages/test-support/loader-smoke/src/index.ts)）
- `@buckeyestudio/toh-native-command`（[`packages/util/native-command/src/index.ts`](../packages/util/native-command/src/index.ts)）
- `@buckeyestudio/toh-output-retention`（[`packages/util/output-retention/src/index.ts`](../packages/util/output-retention/src/index.ts)）
- `@buckeyestudio/toh-sandbox-windows-acl`（[`packages/sandbox/sandbox-windows-acl/src/index.ts`](../packages/sandbox/sandbox-windows-acl/src/index.ts)）
- `@buckeyestudio/toh-scope`（[`packages/core/scope/src/index.ts`](../packages/core/scope/src/index.ts)）
- `@buckeyestudio/toh-sdk-client`（[`packages/sdk/client/src/index.ts`](../packages/sdk/client/src/index.ts)）
...
- `@buckeyestudio/toh-typert-protocol`（[`packages/typert/protocol/src/index.ts`](../packages/typert/protocol/src/index.ts)）
- `@buckeyestudio/toh-typert-registry`（[`packages/typert/registry/src/index.ts`](../packages/typert/registry/src/index.ts)）
