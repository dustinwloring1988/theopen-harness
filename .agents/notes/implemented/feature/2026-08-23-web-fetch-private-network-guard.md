...
The HTTP/1.1-only tradeoff of leaving undici's dispatcher is accepted and documented in the package README; caps, timeout classification, abort propagation, and error codes are unchanged from the caller's perspective except for the added block code.
