/**
 * Package-owned invariant companion for `@buckeyestudio/toh-sdk-jsonrpc-server`.
 * @module @buckeyestudio/toh-sdk-jsonrpc-server/invariant
 */
...
const PACKAGE_NAME = '@buckeyestudio/toh-sdk-jsonrpc-server'
