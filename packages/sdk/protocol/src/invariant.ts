/**
 * Package-owned invariant companion for `@buckeyestudio/toh-sdk-protocol`.
 * @module @buckeyestudio/toh-sdk-protocol/invariant
 */
...
const PACKAGE_NAME = '@buckeyestudio/toh-sdk-protocol'
