/**
 * Package-owned invariant companion for `@buckeyestudio/toh-sdk-client`.
 * @module @buckeyestudio/toh-sdk-client/invariant
 */
...
const PACKAGE_NAME = '@buckeyestudio/toh-sdk-client'
