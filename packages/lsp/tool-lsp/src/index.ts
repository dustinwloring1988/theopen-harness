 ...
 * `toh-tool-call-timeout-policy` to enforce. It runtime-injects only `tools`, `lsp`, and `systemPrompt` and
 * imports no provider.
 *
 * Namespace plugin (named exports, no default export).
 * @module @buckeyestudio/toh-tool-lsp
 */
...
import { LspError } from '@buckeyestudio/toh-lsp'
import type {} from '@buckeyestudio/toh-lsp'
