/**
 * Package-owned invariant companion for `@buckeyestudio/toh-tool-lsp`.
 * @module @buckeyestudio/toh-tool-lsp/invariant
 */
...
const PACKAGE_NAME = '@buckeyestudio/toh-tool-lsp'
