/**
 * Package-owned invariant companion for `@buckeyestudio/toh-anonymous-user-id`.
 * @module @buckeyestudio/toh-anonymous-user-id/invariant
 */
...
const PACKAGE_NAME = '@buckeyestudio/toh-anonymous-user-id'
