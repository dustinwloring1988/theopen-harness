/**
 * Package-owned invariant companion for `@buckeyestudio/toh-cordis-host-runner`.
 * @module @buckeyestudio/toh-cordis-host-runner/invariant
 */
...
const PACKAGE_NAME = '@buckeyestudio/toh-cordis-host-runner'
