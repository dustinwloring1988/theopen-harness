 ...
 * @module @buckeyestudio/toh-cordis-host-runner/guard
 */

import { Context } from '@buckeyestudio/cordis'
import type { Plugin } from '@buckeyestudio/cordis'
import { scopeOf } from '@buckeyestudio/toh-scope'
import { assertSupportedJsonSchema, defineTool } from '@buckeyestudio/toh-tools'
...
function sandboxContext(ctx: Context, reportFailure: (error: Error) => void): Context {
  ...
  // (`@buckeyestudio/toh-cordis-client-runner`, whose CTX_VERBS names this one its
