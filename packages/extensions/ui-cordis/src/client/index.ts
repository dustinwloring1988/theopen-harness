...
import type {} from '@buckeyestudio/toh-client-ui-tool/client'
...
import type { InputTriggerService, InputTriggerSource } from '@buckeyestudio/toh-client-ui-input-trigger/client'
