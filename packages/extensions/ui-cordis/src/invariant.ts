/**
 * Package-owned invariant companion for `@buckeyestudio/toh-client-ui-cordis`.
 * @module @buckeyestudio/toh-client-ui-cordis/invariant
 */
...
const PACKAGE_NAME = '@buckeyestudio/toh-client-ui-cordis'
