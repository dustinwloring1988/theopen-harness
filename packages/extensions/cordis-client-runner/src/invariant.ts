/**
 * Package-owned invariant companion for `@buckeyestudio/toh-cordis-client-runner`.
 * @module @buckeyestudio/toh-cordis-client-runner/invariant
 */
...
const PACKAGE_NAME = '@buckeyestudio/toh-cordis-client-runner'
