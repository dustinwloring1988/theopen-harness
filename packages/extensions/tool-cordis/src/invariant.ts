/**
 * Package-owned invariant companion for `@buckeyestudio/toh-tool-cordis`.
 * @module @buckeyestudio/toh-tool-cordis/invariant
 */
...
const PACKAGE_NAME = '@buckeyestudio/toh-tool-cordis'
