/**
 * Package-owned invariant companion for `@buckeyestudio/toh-shell-env`.
 * @module @buckeyestudio/toh-shell-env/invariant
 */
...
const PACKAGE_NAME = '@buckeyestudio/toh-shell-env'
