/**
 * Package-owned invariant companion for `@buckeyestudio/toh-pwsh-sandbox`.
 * @module @buckeyestudio/toh-pwsh-sandbox/invariant
 */
...
const PACKAGE_NAME = '@buckeyestudio/toh-pwsh-sandbox'
