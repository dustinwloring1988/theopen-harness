 ...
 * mirror of `@buckeyestudio/toh-bash-sandbox/src/helpers.ts` (the pwsh twin of
 * the bash consumer shares the identical classification dialect).
 *
 * @module @buckeyestudio/toh-pwsh-sandbox/helpers
 */

/* jscpd:ignore-start */
import { accessSync, constants, statSync } from 'node:fs'
import type { ShellRunResult } from '@buckeyestudio/toh-shell'
import type { RunnerFailureRule } from '@buckeyestudio/toh-sandbox'
