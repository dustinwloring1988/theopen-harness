 ...
 * twin of `toh-tool-bash`'s background adaptation.
 *
 * @module @buckeyestudio/toh-tool-pwsh/background
 */

import type { ShellProcess } from '@buckeyestudio/toh-shell'

/* jscpd:ignore-start -- deliberate twin of toh-tool-bash/background.ts (Agent Note). */
