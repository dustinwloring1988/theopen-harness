 ...
 * `toh-tool-bash`'s renderer: stdout, a marked stderr section, sandbox
 ...
 * results.
 *
 * @module @buckeyestudio/toh-tool-pwsh/render
 */

import type { ShellProcessRead, ShellSandboxInfo, CollectedOutput } from '@buckeyestudio/toh-shell'
...
/* jscpd:ignore-start -- deliberate twin of toh-tool-bash/render.ts (Agent Note). */
