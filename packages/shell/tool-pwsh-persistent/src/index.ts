 ...
 * @module @buckeyestudio/toh-tool-pwsh-persistent
 */
...
import type { TerminalReadResult, TerminalSendResult, TerminalSessionId } from '@buckeyestudio/toh-terminal'
...
const SHELL_PROMPT = '__TOH_PERSISTENT_PWSH_PROMPT__ '
...
function markers(): CommandMarkers {
  ...
  return {
    start: `__TOH_PERSISTENT_PWSH_START_${nonce}__`,
    end: `__TOH_PERSISTENT_PWSH_END_${nonce}:`,
  }
}
