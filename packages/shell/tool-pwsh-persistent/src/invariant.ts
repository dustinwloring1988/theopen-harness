/**
 * Package-owned invariant companion for `@buckeyestudio/toh-tool-pwsh-persistent`.
 * @module @buckeyestudio/toh-tool-pwsh-persistent/invariant
 */
...
const PACKAGE_NAME = '@buckeyestudio/toh-tool-pwsh-persistent'
