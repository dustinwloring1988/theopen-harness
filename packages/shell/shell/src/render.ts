/**
 * Shared rendering helpers for the shell tools (`toh-tool-bash`,
 * `toh-tool-pwsh`): the exit-status marker contract the tools' renderers
 * emit and the presentation layer parses back.
 * @module @buckeyestudio/toh-shell/render
 */
