/**
 * Package-owned invariant companion for `@buckeyestudio/toh-tool-bash-persistent`.
 * @module @buckeyestudio/toh-tool-bash-persistent/invariant
 */
...
const PACKAGE_NAME = '@buckeyestudio/toh-tool-bash-persistent'
