 ...
 *
 * @module @buckeyestudio/toh-tool-bash/render
 */

import type { ShellProcessRead, ShellRunResult, ShellSandboxInfo, CollectedOutput } from '@buckeyestudio/toh-shell'
import type { SandboxMode } from '@buckeyestudio/toh-sandbox'
import { escalationHintMarker, sandboxDenialMarker } from '@buckeyestudio/toh-sandbox'
 ...
 * rendering story, owned by `@buckeyestudio/toh-shell` so `toh-tool-pwsh` reuses
 ...
 */
export { parseExitStatus, type ParsedExitStatus } from '@buckeyestudio/toh-shell'
