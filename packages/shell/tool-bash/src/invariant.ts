/**
 * Package-owned invariant companion for `@buckeyestudio/toh-tool-bash`.
 * @module @buckeyestudio/toh-tool-bash/invariant
 */
...
const PACKAGE_NAME = '@buckeyestudio/toh-tool-bash'
