/**
 * Package-owned invariant companion for `@buckeyestudio/toh-repeat-tool-reminder`.
 * @module @buckeyestudio/toh-repeat-tool-reminder/invariant
 */
...
const PACKAGE_NAME = '@buckeyestudio/toh-repeat-tool-reminder'
