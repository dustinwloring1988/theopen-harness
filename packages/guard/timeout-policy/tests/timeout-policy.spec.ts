/**
 * Unit + real-load-path coverage for @buckeyestudio/toh-tool-call-timeout-policy. The
...
import { CallId, HarnessError } from '@buckeyestudio/toh-llm'
import SystemPrompt from '@buckeyestudio/toh-system-prompt'
import ToolRuntime, { defineContentToolFixture, TOOL_ABORTED, type ToolExecutionInput, type PostToolDecision } from '@buckeyestudio/toh-tools'
import * as timeoutPolicy from '@buckeyestudio/toh-tool-call-timeout-policy'
import { TOOL_TIMEOUT } from '@buckeyestudio/toh-tool-call-timeout-policy'
...
describe('toh-tool-call-timeout-policy real-load-path guard', () => {
