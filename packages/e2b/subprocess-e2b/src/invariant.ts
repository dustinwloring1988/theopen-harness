/**
 * Package-owned invariant companion for `@buckeyestudio/toh-subprocess-e2b`.
 * @module @buckeyestudio/toh-subprocess-e2b/invariant
 */
...
const PACKAGE_NAME = '@buckeyestudio/toh-subprocess-e2b'
