 ...
 * @module @buckeyestudio/toh-fs-e2b
 */
...
import type { EntryInfo, Sandbox } from '@buckeyestudio/toh-e2b'

const VERSION_METADATA_KEY = 'toh-version'
...
export class E2BFileSystem extends FileSystem {
  ...
  private async writeAtomic(
    ...
    const stagingDirectory = posix.join(posix.dirname(targetPath), `.toh-${randomUUID()}.tmp`)
