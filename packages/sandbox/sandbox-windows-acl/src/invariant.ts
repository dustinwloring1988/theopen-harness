/**
 * Package-owned invariant companion for `@buckeyestudio/toh-sandbox-windows-acl`.
 * @module @buckeyestudio/toh-sandbox-windows-acl/invariant
 */
...
const PACKAGE_NAME = '@buckeyestudio/toh-sandbox-windows-acl'
