/** Package-owned session-event invariants for sandbox policy. @module @buckeyestudio/toh-sandbox-policy/invariant */
...
const PACKAGE_NAME = '@buckeyestudio/toh-sandbox-policy'
