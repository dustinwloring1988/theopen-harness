 ...
 * (`@buckeyestudio/toh-sandbox-local`) and the in-process filesystem fence
 * (`@buckeyestudio/toh-fs-sandbox`) both derive their allow-list here, so "the
