/**
 * Package-owned invariant companion for `@buckeyestudio/toh-headless`.
 * @module @buckeyestudio/toh-headless/invariant
 */

import type { Context } from '@buckeyestudio/cordis'
import type { InvariantInstaller } from '@buckeyestudio/toh-invariants'

const PACKAGE_NAME = '@buckeyestudio/toh-headless'
