/**
 * Package-owned invariant companion for `@buckeyestudio/toh-agent-presets`.
 * @module @buckeyestudio/toh-agent-presets/invariant
 */
...
// joins, and the `agent` field `toh-agent` merges into its context.
...
import { leakedServices, livePresetMounts } from '@buckeyestudio/toh-agent-presets'

const PACKAGE_NAME = '@buckeyestudio/toh-agent-presets'
