 ...
 * @module @buckeyestudio/toh-agent-presets/discovery
 */
...
import { expandHomePath } from '@buckeyestudio/toh-home-paths'
 ...
 *
 * This package owns the writable root the way `toh-skill-filesystem` owns
 * `<tohHome>/skills`. An app must assemble the SHIPPED root, whose path only
