 ...
 *
 * `toh-system-prompt` owns the global persona as its own config, and registers
 ...
 * exactly like the per-child persona `toh-subagent` installs; mounted globally
 ...
 * @module @buckeyestudio/toh-persona
 */
...
import { PERSONA_ORDER, PERSONA_SECTION } from '@buckeyestudio/toh-system-prompt'
