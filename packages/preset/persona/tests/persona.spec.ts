...
import { createScope, type ScopeKey } from '@buckeyestudio/toh-scope'
import { describe, expect, it } from 'vitest'
import * as Persona from '@buckeyestudio/toh-persona'
import { PERSONA_SECTION } from '@buckeyestudio/toh-persona'
