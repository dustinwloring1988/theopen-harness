/**
 * Package-owned invariant companion for `@buckeyestudio/toh-acp-snapshot`.
 * @module @buckeyestudio/toh-acp-snapshot/invariant
 */
...
const PACKAGE_NAME = '@buckeyestudio/toh-acp-snapshot'
