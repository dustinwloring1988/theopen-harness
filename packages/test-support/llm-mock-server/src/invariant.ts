/**
 * Package-owned invariant companion for `@buckeyestudio/toh-llm-mock-server`.
 * @module @buckeyestudio/toh-llm-mock-server/invariant
 */
...
const PACKAGE_NAME = '@buckeyestudio/toh-llm-mock-server'
