/**
 * Package-owned invariant companion for `@buckeyestudio/toh-agent-loop-testkit`.
 * @module @buckeyestudio/toh-agent-loop-testkit/invariant
 */
...
const PACKAGE_NAME = '@buckeyestudio/toh-agent-loop-testkit'
