/**
 * Package-owned invariant companion for `@buckeyestudio/toh-client-test-runtime`.
 * @module @buckeyestudio/toh-client-test-runtime/invariant
 */
...
const PACKAGE_NAME = '@buckeyestudio/toh-client-test-runtime'
