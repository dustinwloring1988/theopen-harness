/**
 * Package-owned invariant companion for `@buckeyestudio/toh-invariants`.
 * @module @buckeyestudio/toh-invariants/invariant
 */
...
const PACKAGE_NAME = '@buckeyestudio/toh-invariants'
