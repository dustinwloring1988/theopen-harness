 ...
 *
 * Policy: a package brands the ids it owns — `CallId` in toh-llm (tool-call
 * correlation), the shared agent/session `SessionId` in toh-session, and
 * `JobId` in toh-jobs. Branding is for ids that cross package boundaries and
 ...
 * package.
 *
 * @module @buckeyestudio/toh-brand
 */
