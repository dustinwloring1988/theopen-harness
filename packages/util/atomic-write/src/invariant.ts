/**
 * Package-owned invariant companion for `@buckeyestudio/toh-atomic-write`.
 * @module @buckeyestudio/toh-atomic-write/invariant
 */
...
const PACKAGE_NAME = '@buckeyestudio/toh-atomic-write'
