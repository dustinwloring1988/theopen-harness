/**
 * Package-owned invariant companion for `@buckeyestudio/toh-launch-environment`.
 * @module @buckeyestudio/toh-launch-environment/invariant
 */
...
const PACKAGE_NAME = '@buckeyestudio/toh-launch-environment'
