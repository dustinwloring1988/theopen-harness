/**
 * Package-owned invariant companion for `@buckeyestudio/toh-native-command`.
 * @module @buckeyestudio/toh-native-command/invariant
 */
...
const PACKAGE_NAME = '@buckeyestudio/toh-native-command'
