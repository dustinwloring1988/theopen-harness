/**
 * Package-owned invariant companion for `@buckeyestudio/toh-home-paths`.
 * @module @buckeyestudio/toh-home-paths/invariant
 */
...
const PACKAGE_NAME = '@buckeyestudio/toh-home-paths'
