...
Indirectly, through consumers such as `toh-tool-call-timeout-policy`, which may replace a provider result with a retained timeout error or suppress a late result.
