...
export function apply(ctx: Context, config: AcpConfig): void {
  ...
  // toh-subagent-acp. The bridge offers one-shot choices only and never infers a
    ...
    return {
      async initialize(_params: InitializeRequest): Promise<InitializeResponse> {
        ...
        return {
          ...
          agentInfo: { name: 'theopen-harness-acp', version: '0.0.1' },
          agentCapabilities: {
