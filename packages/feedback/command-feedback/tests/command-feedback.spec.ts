...
import SessionStore, { foldSurface, Session, SessionId } from '@buckeyestudio/toh-session'
import { SessionTelemetryBackend, type SessionTelemetrySharingStatus } from '@buckeyestudio/toh-session-telemetry'
...
vi.mock('@buckeyestudio/toh-anonymous-user-id', () => ({
...
describe('@buckeyestudio/toh-command-feedback registration', () => {
