/**
 * Package-owned invariant companion for `@buckeyestudio/toh-command-feedback`.
 * @module @buckeyestudio/toh-command-feedback/invariant
 */
...
const PACKAGE_NAME = '@buckeyestudio/toh-command-feedback'
