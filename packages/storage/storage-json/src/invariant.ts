/**
 * Package-owned invariant companion for `@buckeyestudio/toh-storage-json`.
 * @module @buckeyestudio/toh-storage-json/invariant
 */
...
const PACKAGE_NAME = '@buckeyestudio/toh-storage-json'
