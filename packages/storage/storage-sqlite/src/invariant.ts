/**
 * Package-owned invariant companion for `@buckeyestudio/toh-storage-sqlite`.
 * @module @buckeyestudio/toh-storage-sqlite/invariant
 */
...
const PACKAGE_NAME = '@buckeyestudio/toh-storage-sqlite'
