/**
 * Package-owned invariant companion for `@buckeyestudio/toh-storage-domain`: every
 ...
 * @module @buckeyestudio/toh-storage-domain/invariant
 */
...
const PACKAGE_NAME = '@buckeyestudio/toh-storage-domain'
