/** Package-owned hook invocation/result stream invariants. @module @buckeyestudio/toh-hook-protocol/invariant */
...
const PACKAGE_NAME = '@buckeyestudio/toh-hook-protocol'
