/**
 * Package-owned invariant companion for `@buckeyestudio/toh-hooks-codex`.
 * @module @buckeyestudio/toh-hooks-codex/invariant
 */
...
const PACKAGE_NAME = '@buckeyestudio/toh-hooks-codex'
