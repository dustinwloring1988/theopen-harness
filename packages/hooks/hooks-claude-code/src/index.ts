 ...
 * mapping; shared execution and parsing live in `toh-hook-protocol`.
 ...
 * @module @buckeyestudio/toh-hooks-claude-code
 */
...
import type { PostToolDecision, PreToolDecision, ToolExecution, ToolExecutionResult } from '@buckeyestudio/toh-tools'
import {
  appendHookInvoked,
  appendHookResult,
  createDetachedRuns,
...
} from '@buckeyestudio/toh-hook-protocol'
// Pulls in the declaration-merged subagent events and the identity pairing their
// start/end edges.
import type { SubagentRunId } from '@buckeyestudio/toh-subagent'
