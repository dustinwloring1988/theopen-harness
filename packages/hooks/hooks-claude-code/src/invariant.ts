/**
 * Package-owned invariant companion for `@buckeyestudio/toh-hooks-claude-code`.
 * @module @buckeyestudio/toh-hooks-claude-code/invariant
 */
...
const PACKAGE_NAME = '@buckeyestudio/toh-hooks-claude-code'
