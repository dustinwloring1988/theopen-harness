/** Shared top-level-call post-policy selection for search result spill. @module toh-tool-fs-search/direct-call */

import type { Context } from '@buckeyestudio/cordis'
import type { JsonValue, PostToolDecision, ToolDefinition, ToolExecution, ToolExecutionResult } from '@buckeyestudio/toh-tools'
