 ...
 * streams large files, and rejects binary data; line windows belong to `toh-tool-fs`. Writes
 * stage an exclusive owner-only file in a private sibling directory and atomically publish it.
 * @module @buckeyestudio/toh-fs-local/fsio
 */
...
import { FsError, FsTargetKey, FsVersion } from '@buckeyestudio/toh-fs'
