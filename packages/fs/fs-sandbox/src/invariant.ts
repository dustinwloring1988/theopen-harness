/**
 * Package-owned invariant companion for `@buckeyestudio/toh-fs-sandbox`.
 * @module @buckeyestudio/toh-fs-sandbox/invariant
 */
...
const PACKAGE_NAME = '@buckeyestudio/toh-fs-sandbox'
