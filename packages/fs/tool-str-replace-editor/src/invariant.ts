/**
 * Package-owned invariant companion for `@buckeyestudio/toh-tool-str-replace-editor`.
 * @module @buckeyestudio/toh-tool-str-replace-editor/invariant
 */
...
const PACKAGE_NAME = '@buckeyestudio/toh-tool-str-replace-editor'
