 ...
 * @module @buckeyestudio/toh-tool-fs/src/write
 */

import type { Context } from '@buckeyestudio/cordis'
import { defineTool } from '@buckeyestudio/toh-tools'
import type { DiffCallView, DiffResultView, ToolResult } from '@buckeyestudio/toh-tools'
import type { FsWriteOutcome } from '@buckeyestudio/toh-fs'
