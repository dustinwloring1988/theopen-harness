...
import type { GenericCallView, JsonValue, ToolResult, WebFetchResultView } from '@buckeyestudio/toh-tools'
import type { WebFetchBody, WebFetchResult } from '@buckeyestudio/toh-web'
 ...
 * `@buckeyestudio/toh-tool-call-timeout-policy`, not a model argument.
 *
 ...
 *   `ToolDefinition.timeoutMs` for `@buckeyestudio/toh-tool-call-timeout-policy` to enforce.
