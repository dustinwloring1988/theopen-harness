/**
 * Package-owned invariant companion for `@buckeyestudio/toh-tool-web`.
 * @module @buckeyestudio/toh-tool-web/invariant
 */
...
const PACKAGE_NAME = '@buckeyestudio/toh-tool-web'
