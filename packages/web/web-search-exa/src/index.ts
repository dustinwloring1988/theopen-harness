/**
 * `@buckeyestudio/toh-web-search-exa`: registers an Exa-backed `WebSearchProvider`
 ...
 * seam's provider registry, exactly as `@buckeyestudio/toh-llm-deepseek`
 * registers an adapter into `ctx.llm`. The key is owned by `@buckeyestudio/toh-web`.
 *
 * @module @buckeyestudio/toh-web-search-exa
 */

import type { Context } from '@buckeyestudio/cordis'
import { launchEnvironmentOf } from '@buckeyestudio/toh-launch-environment'
import z from '@buckeyestudio/schemastery'
import type {} from '@buckeyestudio/toh-web'
import {
  ExaSearchProvider,
