/**
 * Package-owned invariant companion for `@buckeyestudio/toh-session-telemetry`.
 * @module @buckeyestudio/toh-session-telemetry/invariant
 */
...
const PACKAGE_NAME = '@buckeyestudio/toh-session-telemetry'
