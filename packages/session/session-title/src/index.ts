 ...
 * @module @buckeyestudio/toh-session-title
 */

import { Context, FiberState, Service, type Fiber } from '@buckeyestudio/cordis'
import z from '@buckeyestudio/schemastery'
import { z as zod } from 'zod'
import type { Branded } from '@buckeyestudio/toh-brand'
import { assertNever, deepFreeze, isAgentLoopRequest } from '@buckeyestudio/toh-llm'
import type { GenerateOptions } from '@buckeyestudio/toh-llm'
import type {
  Session,
  SessionEvent,
