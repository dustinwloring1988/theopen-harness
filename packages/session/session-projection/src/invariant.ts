/**
 * Package-owned invariant companion for `@buckeyestudio/toh-session-projection`.
 * @module @buckeyestudio/toh-session-projection/invariant
 */
...
const PACKAGE_NAME = '@buckeyestudio/toh-session-projection'
