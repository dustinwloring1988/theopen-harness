/**
 * Package-owned invariant companion for `@buckeyestudio/toh-session-checkpoint-policy`.
 * @module @buckeyestudio/toh-session-checkpoint-policy/invariant
 */
...
const PACKAGE_NAME = '@buckeyestudio/toh-session-checkpoint-policy'
