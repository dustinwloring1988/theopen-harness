/**
 * Package-owned invariant companion for `@buckeyestudio/toh-session-title-first-prompt-llm`.
 * @module @buckeyestudio/toh-session-title-first-prompt-llm/invariant
 */
...
const PACKAGE_NAME = '@buckeyestudio/toh-session-title-first-prompt-llm'
