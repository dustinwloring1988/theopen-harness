 ...
 * (`deriveStats` in toh-client-ui-conversation, that fold's whole-window
 ...
 *
 * @module @buckeyestudio/toh-session-stats/projection
 */

import { z } from 'zod'
import { isTokenDelta } from '@buckeyestudio/toh-llm/message'
