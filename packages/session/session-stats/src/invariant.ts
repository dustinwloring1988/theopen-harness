/**
 * Package-owned invariant companion for `@buckeyestudio/toh-session-stats`.
 * @module @buckeyestudio/toh-session-stats/invariant
 */
...
const PACKAGE_NAME = '@buckeyestudio/toh-session-stats'
 ...
 * ids) are owned and runtime-checked by toh-agent-loop and the session
 * surface, not here.
 */
