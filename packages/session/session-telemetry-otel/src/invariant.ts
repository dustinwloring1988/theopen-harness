/**
 * Package-owned invariant companion for `@buckeyestudio/toh-session-telemetry-otel`.
 * @module @buckeyestudio/toh-session-telemetry-otel/invariant
 */
...
const PACKAGE_NAME = '@buckeyestudio/toh-session-telemetry-otel'
