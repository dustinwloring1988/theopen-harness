/**
 * OpenTelemetry Service Provider for the TheOpen Harness telemetry capability.
 *
 ...
 *
 * @module @buckeyestudio/toh-session-telemetry-otel
 */

import { createRequire } from 'node:module'
import z from '@buckeyestudio/schemastery'
import type { Context } from '@buckeyestudio/cordis'
import type {} from '@buckeyestudio/toh-command-feedback'
import {
...
} from '@buckeyestudio/toh-session-telemetry'
import { APP_IDENTITY } from '@buckeyestudio/toh-llm'
...
// version (same pattern as toh-llm's attribution identity).
...
export class OpenTelemetrySessionBackend extends SessionTelemetryBackend {
  ...
  constructor(ctx: Context, config: Config) {
    ...
    const ledger = this.provider.getLogger('@buckeyestudio/toh-session-telemetry-otel', version)
    const ops = this.provider.getLogger('@buckeyestudio/toh-session-telemetry-otel/ops', version)
