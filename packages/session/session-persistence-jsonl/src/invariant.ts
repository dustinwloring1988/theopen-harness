/**
 * Package-owned invariant companion for `@buckeyestudio/toh-session-persistence-jsonl`.
 * @module @buckeyestudio/toh-session-persistence-jsonl/invariant
 */
...
const PACKAGE_NAME = '@buckeyestudio/toh-session-persistence-jsonl'
