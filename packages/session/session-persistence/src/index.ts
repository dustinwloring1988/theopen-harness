 ...
 * @module @buckeyestudio/toh-session-persistence
 */

import { Context, Service } from '@buckeyestudio/cordis'
import { SessionPreparation } from '@buckeyestudio/toh-session'
import type { SessionEvent, SessionId, SessionHeader } from '@buckeyestudio/toh-session'
import type { SessionPersistenceRevision } from './revision.ts'

// Re-export the metadata vocabulary so Consumers import it from the Service Definition.
export type { SessionHeader } from '@buckeyestudio/toh-session'
