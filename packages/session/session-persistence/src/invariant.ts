/**
 * Package-owned invariant companion for `@buckeyestudio/toh-session-persistence`.
 * @module @buckeyestudio/toh-session-persistence/invariant
 */
...
const PACKAGE_NAME = '@buckeyestudio/toh-session-persistence'
