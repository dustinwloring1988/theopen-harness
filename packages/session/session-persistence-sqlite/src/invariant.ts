/**
 * Package-owned invariant companion for `@buckeyestudio/toh-session-persistence-sqlite`.
 * @module @buckeyestudio/toh-session-persistence-sqlite/invariant
 */
...
const PACKAGE_NAME = '@buckeyestudio/toh-session-persistence-sqlite'
