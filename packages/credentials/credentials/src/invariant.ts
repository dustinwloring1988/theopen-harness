/**
 * Package-owned invariant companion for `@buckeyestudio/toh-credentials`.
 * @module @buckeyestudio/toh-credentials/invariant
 */

import type { Context } from '@buckeyestudio/cordis'
import type { InvariantFailure, InvariantInstaller } from '@buckeyestudio/toh-invariants'

const PACKAGE_NAME = '@buckeyestudio/toh-credentials'
