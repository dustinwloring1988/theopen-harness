/**
 * Package-owned invariant companion for `@buckeyestudio/toh-authorization`.
 * @module @buckeyestudio/toh-authorization/invariant
 */

import type { Context } from '@buckeyestudio/cordis'
import type { InvariantFailure, InvariantInstaller } from '@buckeyestudio/toh-invariants'

const PACKAGE_NAME = '@buckeyestudio/toh-authorization'
