...
const KEY = credentialRef('TOH_CRED_PIPE')
...
async function tempDir(): Promise<string> {
  const dir = await mkdtemp(join(tmpdir(), 'toh-credentials-watch-'))
