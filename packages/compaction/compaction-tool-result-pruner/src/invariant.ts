/**
 * Package-owned invariant companion for `@buckeyestudio/toh-compaction-tool-result-pruner`.
 * @module @buckeyestudio/toh-compaction-tool-result-pruner/invariant
 */
...
const PACKAGE_NAME = '@buckeyestudio/toh-compaction-tool-result-pruner'
