 ...
 *
 * @module @buckeyestudio/toh-compaction-basic/summarizer
 */

import type { Context } from '@buckeyestudio/cordis'
import { contentHasImage, createUserMessage, BlockAssembler, LlmError } from '@buckeyestudio/toh-llm'
import type {
...
export async function summarizeWithLlm(
  ...
  const messages: Message[] = [
    ...
    createUserMessage({
      ...
      source: { kind: 'plugin', plugin: 'toh-compaction-basic' },
    }),
  ]
