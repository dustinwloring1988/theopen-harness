 ...
 *
 * The seam itself lives in `@buckeyestudio/toh-compaction`, which re-exports these
 ...
 * `toh-commands/brand` shape.
 *
 * @module @buckeyestudio/toh-compaction/checkpoint
 */

import type { MessageSource } from '@buckeyestudio/toh-llm/message'
