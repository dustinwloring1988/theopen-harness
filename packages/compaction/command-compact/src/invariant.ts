/**
 * Package-owned invariant companion for `@buckeyestudio/toh-command-compact`.
 * @module @buckeyestudio/toh-command-compact/invariant
 */
...
const PACKAGE_NAME = '@buckeyestudio/toh-command-compact'
