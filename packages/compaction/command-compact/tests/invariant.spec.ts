...
import * as invariant from '@buckeyestudio/toh-command-compact/invariant'
...
describe('command-compact invariant companion', () => {
  it('registers the package-owned no-op installer', async () => {
    ...
    expect(register).toHaveBeenCalledWith('@buckeyestudio/toh-command-compact', expect.any(Function))
    expect(() => {
