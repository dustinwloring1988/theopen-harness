...
import * as commandCompact from '@buckeyestudio/toh-command-compact'
...
describe('command-compact real Loader composition', () => {
  it('discovers and executes /compact through the assembled command plane', async () => {
    root = await mkdtemp(join(tmpdir(), 'toh-command-compact-loader-'))
    ...
    const modules = new Map<string, unknown>([
      ...
      ['@buckeyestudio/toh-command-compact', commandCompact],
    ])
