 ...
 * (`@buckeyestudio/toh-subagent-spawn-in-process`, `-fork`, `-acp`) and the model-facing
 * consumer (`@buckeyestudio/toh-tool-subagent`) are separate packages.
 *
...
import { assertObjectJsonSchema } from '@buckeyestudio/toh-tools'
import type { ContentBlock, MessageId } from '@buckeyestudio/toh-llm'
