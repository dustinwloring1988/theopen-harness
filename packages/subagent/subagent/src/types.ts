 ...
 *
 * @module @buckeyestudio/toh-subagent/types
 */

import type { Agent, AgentOptions } from '@buckeyestudio/toh-agent'
...
import type { ObjectJsonSchema, ToolRestriction } from '@buckeyestudio/toh-tools'
