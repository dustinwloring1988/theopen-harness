...
import type { ProjectionDefinition } from '@buckeyestudio/toh-session-projection'
import SessionProjectionCache from '@buckeyestudio/toh-session-projection-cache'
...
async function setup(
  ...
  const root = mkdtempSync(join(tmpdir(), 'toh-subagent-list-'))
  roots.push(root)
