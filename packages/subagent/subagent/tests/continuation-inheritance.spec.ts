...
import SandboxPolicyService, { effectiveSandboxMode, setSandboxMode } from '@buckeyestudio/toh-sandbox-policy'
...
import ApprovalService, { effectiveApprovalPolicy } from '@buckeyestudio/toh-user-approval'
...
async function setup(script: Script) {
  ...
  const root = mkdtempSync(join(tmpdir(), 'toh-continuation-inherit-'))
  roots.push(root)
