/**
 * Package-owned invariant companion for `@buckeyestudio/toh-tool-subagent`.
 * @module @buckeyestudio/toh-tool-subagent/invariant
 */
...
const PACKAGE_NAME = '@buckeyestudio/toh-tool-subagent'
