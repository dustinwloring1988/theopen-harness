/**
 * Package-owned invariant companion for `@buckeyestudio/toh-tool-subagent-control`.
 * @module @buckeyestudio/toh-tool-subagent-control/invariant
 */
...
const PACKAGE_NAME = '@buckeyestudio/toh-tool-subagent-control'
