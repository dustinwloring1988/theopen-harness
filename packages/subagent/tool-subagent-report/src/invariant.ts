/**
 * Package-owned invariant companion for `@buckeyestudio/toh-tool-subagent-report`.
 * @module @buckeyestudio/toh-tool-subagent-report/invariant
 */
...
const PACKAGE_NAME = '@buckeyestudio/toh-tool-subagent-report'
