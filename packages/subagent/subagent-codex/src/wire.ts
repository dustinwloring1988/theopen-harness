 ...
 *
 * @module @buckeyestudio/toh-subagent-codex/wire
 */

import type { Readable, Writable } from 'node:stream'
import type { ContentBlock } from '@buckeyestudio/toh-llm'
import type { SubagentResult } from '@buckeyestudio/toh-subagent'
import { JsonRpcLineTransport } from '@buckeyestudio/toh-sdk-protocol'
