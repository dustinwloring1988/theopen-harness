 ...
 * @module @buckeyestudio/toh-subagent-in-process-driver/structured
 */

import type { Context } from '@buckeyestudio/cordis'
import type { ToolSchema } from '@buckeyestudio/toh-llm'
import type { ToolExecution, ToolRunContext } from '@buckeyestudio/toh-tools'
import { ToolArgsError, validateJsonSchemaValue, type ObjectJsonSchema } from '@buckeyestudio/toh-tools'
 ...
 *   `assertObjectJsonSchema` in toh-tools).
