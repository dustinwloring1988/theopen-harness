 ...
 *
 * @module @buckeyestudio/toh-agent-instructions/render
 */
...
/**
 * File name of the single user-global instruction file under `$TOH_HOME`.
 * Discovery (`$TOH_HOME/<name>`) and reconciliation (the user-global scope key's
...
export function scopeForDisplayPath(displayPath: string): string {
  if (displayPath === '~/.toh/AGENTS.md' || displayPath === '$TOH_HOME/AGENTS.md') return USER_GLOBAL_DIRECTORY
