 ...
 * mount it as a no-op.
 *
 * @module @buckeyestudio/toh-agent-instructions
 */
...
import type { ToolExecution, ToolExecutionResult, ToolExecutionToken } from '@buckeyestudio/toh-tools'
