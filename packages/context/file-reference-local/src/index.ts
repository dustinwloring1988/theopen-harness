 ...
 *
 * @module @buckeyestudio/toh-file-reference-local
 */
...
} from '@buckeyestudio/toh-file-reference'
...
export { FILE_REFERENCE_PROMPT } from '@buckeyestudio/toh-file-reference'
export { activeAtToken, formatFileMention } from '@buckeyestudio/toh-file-reference/grammar'
