/**
 * Package-owned invariant companion for `@buckeyestudio/toh-file-reference-local`.
 * @module @buckeyestudio/toh-file-reference-local/invariant
 */
...
const PACKAGE_NAME = '@buckeyestudio/toh-file-reference-local'
