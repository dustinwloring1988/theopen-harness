# `@buckeyestudio/toh-file-reference`
...
Indirectly, through `@buckeyestudio/toh-file-reference-local`, which conditionally contributes this package's stable file-reference guidance.
