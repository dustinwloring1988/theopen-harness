/**
 * Package-owned invariant companion for `@buckeyestudio/toh-tmux-context`.
 * @module @buckeyestudio/toh-tmux-context/invariant
 */
...
const PACKAGE_NAME = '@buckeyestudio/toh-tmux-context'
