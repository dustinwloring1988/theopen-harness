 ...
 * @module @buckeyestudio/toh-session-reference/types
 */

import type { UserMessage } from '@buckeyestudio/toh-llm/message'
...
export interface SessionReferenceMentionCandidate extends SessionReferenceCandidate {
  /** Canonical `@[label](toh-session:…)` mention serialized into the prompt draft. */
  mention: string
}
