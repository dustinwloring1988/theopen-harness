/**
 * Package-owned invariant companion for `@buckeyestudio/toh-session-reference`.
 * @module @buckeyestudio/toh-session-reference/invariant
 */
...
const PACKAGE_NAME = '@buckeyestudio/toh-session-reference'
