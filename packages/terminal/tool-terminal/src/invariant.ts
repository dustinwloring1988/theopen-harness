/**
 * Package-owned invariant companion for `@buckeyestudio/toh-tool-terminal`.
 * @module @buckeyestudio/toh-tool-terminal/invariant
 */
...
const PACKAGE_NAME = '@buckeyestudio/toh-tool-terminal'
