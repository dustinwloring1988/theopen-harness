/**
 * Package-owned invariant companion for `@buckeyestudio/toh-terminal-bash`.
 * @module @buckeyestudio/toh-terminal-bash/invariant
 */
...
const PACKAGE_NAME = '@buckeyestudio/toh-terminal-bash'
