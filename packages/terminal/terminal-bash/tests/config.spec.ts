...
import type { Config } from '@buckeyestudio/toh-terminal-bash/src/config.ts'
import { resolveConfig, validateConfig } from '@buckeyestudio/toh-terminal-bash/src/config.ts'
