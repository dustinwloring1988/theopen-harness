/**
 * Package-owned invariant companion for `@buckeyestudio/toh-code-runtime-python`.
 * @module @buckeyestudio/toh-code-runtime-python/invariant
 */
...
const PACKAGE_NAME = '@buckeyestudio/toh-code-runtime-python'
