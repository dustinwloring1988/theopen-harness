/**
 * Package-owned invariant companion for `@buckeyestudio/toh-code-runtime-worker-thread`.
 * @module @buckeyestudio/toh-code-runtime-worker-thread/invariant
 */
...
const PACKAGE_NAME = '@buckeyestudio/toh-code-runtime-worker-thread'
