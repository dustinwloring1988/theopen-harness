/** JSON string-prefix accounting for the outer-output ledger. @module @buckeyestudio/toh-code-runtime-worker-thread/output-json */

import type { CodeJsonValue } from '@buckeyestudio/toh-code-runtime'
