/**
 * Package-owned invariant companion for `@buckeyestudio/toh-typert-protocol`.
 * @module @buckeyestudio/toh-typert-protocol/invariant
 */
...
const PACKAGE_NAME = '@buckeyestudio/toh-typert-protocol'
