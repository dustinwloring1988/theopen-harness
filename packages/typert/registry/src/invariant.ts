/**
 * Package-owned invariant companion for `@buckeyestudio/toh-typert-registry`.
 * @module @buckeyestudio/toh-typert-registry/invariant
 */
...
const PACKAGE_NAME = '@buckeyestudio/toh-typert-registry'
