/**
 * Package-owned invariant companion for `@buckeyestudio/toh-typert-generator`.
 * @module @buckeyestudio/toh-typert-generator/invariant
 */
...
const PACKAGE_NAME = '@buckeyestudio/toh-typert-generator'
