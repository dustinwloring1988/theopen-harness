/**
 * Package-owned invariant companion for `@buckeyestudio/toh-typert-loader`.
 * @module @buckeyestudio/toh-typert-loader/invariant
 */
...
const PACKAGE_NAME = '@buckeyestudio/toh-typert-loader'
