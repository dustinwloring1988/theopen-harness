/**
 * Package-owned invariant companion for `@buckeyestudio/toh-session-query-sqlite`.
 * @module @buckeyestudio/toh-session-query-sqlite/invariant
 */
...
const PACKAGE_NAME = '@buckeyestudio/toh-session-query-sqlite'
