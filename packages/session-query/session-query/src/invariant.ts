/**
 * Package-owned invariant companion for `@buckeyestudio/toh-session-query`.
 * @module @buckeyestudio/toh-session-query/invariant
 */
...
const PACKAGE_NAME = '@buckeyestudio/toh-session-query'
