 ...
 *
 * @module @buckeyestudio/toh-session-query
 */

import { Context, Service } from '@buckeyestudio/cordis'
import { Session, snapshotSessionEvent, type SessionId } from '@buckeyestudio/toh-session'
import { foldSessionTitle } from '@buckeyestudio/toh-session-title'
import type { SessionTitleSnapshot } from '@buckeyestudio/toh-session-title'
import type {
