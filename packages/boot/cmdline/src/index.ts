/**
 * @buckeyestudio/toh-cmdline — the command line a toh launcher hands to the app
 * it boots.
 *
 ...
 * @module @buckeyestudio/toh-cmdline
 */
 ...
 * verbatim and in argv order. `toh --profile tui --resume abc` yields
 * `['--resume', 'abc']`.
 */
