/**
 * Package-owned invariant companion for `@buckeyestudio/toh-app-boot`.
 * @module @buckeyestudio/toh-app-boot/invariant
 */
...
const PACKAGE_NAME = '@buckeyestudio/toh-app-boot'
