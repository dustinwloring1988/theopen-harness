/**
 * Package-owned invariant companion for `@buckeyestudio/toh-settings`.
 * @module @buckeyestudio/toh-settings/invariant
 */
...
const PACKAGE_NAME = '@buckeyestudio/toh-settings'
