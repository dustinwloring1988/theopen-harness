 ...
 *
 * @module toh-llm-pi-ai/discovery
 */

import { INVALID_CREDENTIAL_CODE, LlmError, normalizeApiKey } from '@buckeyestudio/toh-llm'
import type { LlmDiscoveredModel, LlmModelDiscoveryRequest } from '@buckeyestudio/toh-llm'
import { attributionHeaders } from '@buckeyestudio/toh-llm'
 ...
 * on the length the server claims — the same two-stage shape `toh-web-fetch`
