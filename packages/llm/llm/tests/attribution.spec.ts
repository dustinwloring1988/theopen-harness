...
import { APP_IDENTITY, attributionHeaders, userAgent } from '@buckeyestudio/toh-llm'
import type { AppIdentity } from '@buckeyestudio/toh-llm'
...
describe('userAgent', () => {
  it('renders product/version with the +url comment', () => {
    expect(userAgent()).toBe(
      `theopen-harness/${manifest.version} (+https://github.com/dustinwloring1988/theopen-harness)`,
    )
  })
