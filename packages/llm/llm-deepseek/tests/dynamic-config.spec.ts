...
import LlmRuntime, { createUserMessage, INVALID_CREDENTIAL_CODE } from '@buckeyestudio/toh-llm'
...
async function home(): Promise<string> {
  const dir = await mkdtemp(join(tmpdir(), 'toh-llm-dynamic-'))
