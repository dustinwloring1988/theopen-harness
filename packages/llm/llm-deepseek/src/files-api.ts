/** OpenAI-compatible DeepSeek Files API transport. @module toh-llm-deepseek/files-api */

import { attributionHeaders, LlmError } from '@buckeyestudio/toh-llm'
import type { ImageMediaType } from '@buckeyestudio/toh-attachment'
