/**
 * Package-owned invariant companion for `@buckeyestudio/toh-token-meter`.
 * @module @buckeyestudio/toh-token-meter/invariant
 */
...
const PACKAGE_NAME = '@buckeyestudio/toh-token-meter'
