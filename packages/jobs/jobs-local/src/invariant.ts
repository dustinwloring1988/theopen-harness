/**
 * Package-owned invariant companion for `@buckeyestudio/toh-jobs-local`.
 * @module @buckeyestudio/toh-jobs-local/invariant
 */
...
const PACKAGE_NAME = '@buckeyestudio/toh-jobs-local'
...
/**
 * No runtime invariant: `@buckeyestudio/toh-jobs/invariant` owns per-snapshot identity, status,
