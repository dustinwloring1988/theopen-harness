...
import HttpServer from '@buckeyestudio/toh-host-webserver'
import type { DirectoryPicker } from '@buckeyestudio/toh-host-directory-picker'
import BrowseDirectoryPicker from '@buckeyestudio/toh-host-directory-picker-browse'
import NativeDirectoryPicker from '@buckeyestudio/toh-host-directory-picker-native'
...
const AUTO = '@buckeyestudio/toh-host-directory-picker-auto'
const NATIVE = '@buckeyestudio/toh-host-directory-picker-native'
const BROWSE = '@buckeyestudio/toh-host-directory-picker-browse'
const NATIVE_SURFACE = '@buckeyestudio/toh-client-ui-directory-picker-native'
const BROWSE_SURFACE = '@buckeyestudio/toh-client-ui-directory-picker-browse'
...
async function loadComposition(
  ...
  root = await mkdtemp(join(tmpdir(), 'toh-directory-picker-auto-'))
  ...
  const modules = new Map<string, unknown>([
    ['@buckeyestudio/toh-host-webserver', HttpServer],
...
function stubAttendedHost(): void {
  fakeBin = mkdtempSync(join(tmpdir(), 'toh-picker-bin-'))
