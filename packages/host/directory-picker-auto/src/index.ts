 ...
 * @module @buckeyestudio/toh-host-directory-picker-auto
 */
...
export const BACKEND_PACKAGES: Record<DirectoryPickerBackendKind, string> = {
  native: '@buckeyestudio/toh-host-directory-picker-native',
  browse: '@buckeyestudio/toh-host-directory-picker-browse',
}
...
export const SURFACE_PACKAGES: Record<DirectoryPickerBackendKind, string> = {
  native: '@buckeyestudio/toh-client-ui-directory-picker-native',
  browse: '@buckeyestudio/toh-client-ui-directory-picker-browse',
}
