/**
 * Package-owned invariant companion for `@buckeyestudio/toh-host-frontend-static`.
 * @module @buckeyestudio/toh-host-frontend-static/invariant
 */

import type { Context } from '@buckeyestudio/cordis'
import type { InvariantInstaller } from '@buckeyestudio/toh-invariants'

const PACKAGE_NAME = '@buckeyestudio/toh-host-frontend-static'
