...
import type { AttachmentIdType, ImageAttachmentLimits, ImageAttachmentRef } from '@buckeyestudio/toh-attachment'
 ...
 * the toh-tools vocabulary into this schema and drift with it.
 */
