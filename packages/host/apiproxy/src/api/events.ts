...
import type { AskUserQuestionItem } from '@buckeyestudio/toh-user-questions/types'
import type { ApprovalOutcome, ApprovalRequestId } from '@buckeyestudio/toh-user-approval/types'
import type { Message } from '@buckeyestudio/toh-llm/types'
import type { MessageId } from '@buckeyestudio/toh-llm/brand'
import type { CallId } from '@buckeyestudio/toh-llm/brand'
import type { JsonValue, SessionEvent, SessionId } from '@buckeyestudio/toh-session/types'
import type { ToolCallView, ToolResultView } from '@buckeyestudio/toh-tools/presentation'
import type { RpcError, RpcId, RpcRequest } from './rpc.ts'
import type { JobView } from './jobs.ts'
import type { WorkspaceView } from './workspace.ts'

// Client-side consumers take the render-intent vocabulary from the contract;
// toh-tools remains its owner.
export type { ToolCallView, ToolResultView } from '@buckeyestudio/toh-tools/presentation'
...
export type HostFrame =
   ...
   * owned by `@buckeyestudio/toh-api-remotes` (`API_REMOTE_FORWARDED_EVENTS`),
