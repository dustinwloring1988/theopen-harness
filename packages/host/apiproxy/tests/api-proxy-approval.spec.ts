...
import type { ApprovalRequestId } from '@buckeyestudio/toh-user-approval'
import type { ApiProxy, MuxFrame, RpcRequest } from '@buckeyestudio/toh-host-apiproxy/api'
import type { RpcId } from '@buckeyestudio/toh-host-apiproxy/api/rpc'
import { RpcId as mintRpcId } from '@buckeyestudio/toh-host-apiproxy/api/rpc'
