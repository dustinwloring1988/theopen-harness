 ...
 *
 * @module @buckeyestudio/toh-session
 */

import { Context, Service } from '@buckeyestudio/cordis'
import { isAbsolute } from 'node:path'
import { deepFreeze } from '@buckeyestudio/toh-llm'
import { scopeOf, scopeTarget } from '@buckeyestudio/toh-scope'
import type { Scoped } from '@buckeyestudio/toh-scope'
import type { Message } from '@buckeyestudio/toh-llm'
import { SESSION_FORMAT_VERSION, SessionId } from './types.ts'
import type { TypertLookup } from '@buckeyestudio/toh-typert-protocol'
...
export type { AssistantMessage, ToolResultMessage, UserMessage } from '@buckeyestudio/toh-llm'
  ...
  constructor(ctx: Context) {
    ...
    ctx.inject(['typert'], (typeCtx) => {
      typeCtx.typert.lookups.register('session', {
        parameter: 'session',
        wire: 'sessionId',
        hostTypeSymbol: '@buckeyestudio/toh-session#Session',
        wireTypeSymbol: '@buckeyestudio/toh-session/types#SessionId',
