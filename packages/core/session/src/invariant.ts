 ...
 * companion beside `@buckeyestudio/toh-invariants` to enable the checks.
 *
 * @module @buckeyestudio/toh-session/invariant
 */
...
const PACKAGE_NAME = '@buckeyestudio/toh-session'
