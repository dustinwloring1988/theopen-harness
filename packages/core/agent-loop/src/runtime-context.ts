 ...
 * @module @buckeyestudio/toh-agent-loop/runtime-context
 */

import { createUserMessage } from '@buckeyestudio/toh-llm'
import type { ContextSnapshotSection } from '@buckeyestudio/toh-llm'
import type { Session, UserMessage } from '@buckeyestudio/toh-session'
import { isReplacementSurfaceEvent } from '@buckeyestudio/toh-session'
import type { Context } from '@buckeyestudio/cordis'

const SOURCE = '@buckeyestudio/toh-system-prompt'
