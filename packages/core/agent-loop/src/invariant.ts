 ...
 * @module @buckeyestudio/toh-agent-loop/invariant
 */

import type { Context } from '@buckeyestudio/cordis'
import { isAgentLoopRequest, type GenerateOptions } from '@buckeyestudio/toh-llm'
import type { InvariantFailure, InvariantInstaller } from '@buckeyestudio/toh-invariants'
import { foldRequestHeader } from '@buckeyestudio/toh-session'

const PACKAGE_NAME = '@buckeyestudio/toh-agent-loop'
