 ...
 * @module @buckeyestudio/toh-agent/dispatch
 */

import type { Context, Events } from '@buckeyestudio/cordis'
import { scopeTarget } from '@buckeyestudio/toh-scope'
import type { Scoped } from '@buckeyestudio/toh-scope'
import type { AssembleContext } from '@buckeyestudio/toh-system-prompt'
