 ...
 * ([`toh-code-runtime-worker-thread`](../../code-runtime/code-runtime-worker/README.md)).
 ...
 * @module @buckeyestudio/toh-agent-tool-presentation
 */

import type { Context } from '@buckeyestudio/cordis'
import z from '@buckeyestudio/schemastery'
import type { ToolPresentationMode } from '@buckeyestudio/toh-tools'
...
export function apply(ctx: Context, config: Config): void {
  ...
  // what `toh-agent-presets` reports as an unusable row, naming this id.
