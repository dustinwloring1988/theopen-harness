/** Package-owned scoped-dispatch invariants. @module @buckeyestudio/toh-scope/invariant */

import type { Context } from '@buckeyestudio/cordis'
import type { InvariantInstaller } from '@buckeyestudio/toh-invariants'
import { carrierKeyOf, isScopeCarrier } from '@buckeyestudio/toh-scope'
import { scopedSubjectResolverFor } from './scoped-events.generated.ts'

const PACKAGE_NAME = '@buckeyestudio/toh-scope'
