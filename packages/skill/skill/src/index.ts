 ...
 * Concrete
 * providers such as `@buckeyestudio/toh-skill-filesystem` decide where skills come
 ...
 *
 * @module @buckeyestudio/toh-skill
 */

import { Context, Service } from '@buckeyestudio/cordis'
import { assertNever } from '@buckeyestudio/toh-llm'
import { NamedEntries, ScopedLayers, scopeChainOf, scopeOf } from '@buckeyestudio/toh-scope'
import type { ScopeKey, ScopeLayer } from '@buckeyestudio/toh-scope'
...
export type SkillSource = 'project-toh' | 'project-agents' | 'runtime' | 'user-toh' | 'user-agents' | 'custom' | 'bundled' | (string & {})
