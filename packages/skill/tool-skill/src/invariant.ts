/**
 * Package-owned invariant companion for `@buckeyestudio/toh-tool-skill`.
 * @module @buckeyestudio/toh-tool-skill/invariant
 */
...
const PACKAGE_NAME = '@buckeyestudio/toh-tool-skill'
