/**
 * Package-owned invariant companion for `@buckeyestudio/toh-skill-badge`.
 * @module @buckeyestudio/toh-skill-badge/invariant
 */
...
const PACKAGE_NAME = '@buckeyestudio/toh-skill-badge'
