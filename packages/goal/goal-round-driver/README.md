# @buckeyestudio/toh-goal-round-driver
...
```yaml
- id: goal
  name: '@buckeyestudio/toh-goal'

- id: tool-goal
  name: '@buckeyestudio/toh-tool-goal'

- id: goal-round-driver
  name: '@buckeyestudio/toh-goal-round-driver'
```

The plugin has no tunable configuration. `maxGoalRounds` belongs to the goal definition, while the model-facing blocked threshold belongs to [`toh-tool-goal`](../tool-goal/README.md); duplicating either value in the driver could produce divergent policy.
