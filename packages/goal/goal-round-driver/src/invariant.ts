/** Package-owned goal-round prompt invariants. @module @buckeyestudio/toh-goal-round-driver/invariant */

import { isDeepStrictEqual } from 'node:util'
import type { Context } from '@buckeyestudio/cordis'
import { foldGoal, type FoldedGoal, type GoalMessageSource, type GoalView } from '@buckeyestudio/toh-goal'
...
const PACKAGE_NAME = '@buckeyestudio/toh-goal-round-driver'
