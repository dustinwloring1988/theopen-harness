/**
 * Package-owned invariant companion for `@buckeyestudio/toh-tool-goal`.
 * @module @buckeyestudio/toh-tool-goal/invariant
 */
...
const PACKAGE_NAME = '@buckeyestudio/toh-tool-goal'
