 ...
 * @module @buckeyestudio/toh-tool-goal
 */

import type { Context } from '@buckeyestudio/cordis'
import z from '@buckeyestudio/schemastery'
import { GoalId } from '@buckeyestudio/toh-goal'
import type { GoalRef, GoalView } from '@buckeyestudio/toh-goal'
import { boundContextSummary, createUserMessage, HarnessError } from '@buckeyestudio/toh-llm'
