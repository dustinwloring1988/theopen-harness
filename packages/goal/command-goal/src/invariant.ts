/**
 * Package-owned invariant companion for `@buckeyestudio/toh-command-goal`.
 * @module @buckeyestudio/toh-command-goal/invariant
 */
...
const PACKAGE_NAME = '@buckeyestudio/toh-command-goal'
