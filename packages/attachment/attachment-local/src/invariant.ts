/** Package-owned invariant companion for `@buckeyestudio/toh-attachment-local`. @module @buckeyestudio/toh-attachment-local/invariant */

/* jscpd:ignore-start */
import type { Context } from '@buckeyestudio/cordis'
import type { InvariantInstaller } from '@buckeyestudio/toh-invariants'

const PACKAGE_NAME = '@buckeyestudio/toh-attachment-local'
