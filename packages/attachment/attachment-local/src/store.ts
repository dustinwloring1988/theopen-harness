...
/**
 * Establish this process's proof that one TOH_HOME entry and every ancestor
 ...
 * @param root - absolute `TOH_HOME/attachments/v1` root.
...
export async function commitPreparedImageFile(
  ...
  // Establish TOH_HOME itself against the filesystem root once per process.
