...
| Package | Role |
|---|---|
| `@buckeyestudio/toh-spill` (this) | Service Definition: abstract service + vocabulary types |
| `@buckeyestudio/toh-spill-local` | Service Provider: private session-scoped files on the host filesystem |
| `@buckeyestudio/toh-spill-policy` | Consumer: the tool-result policy that spills oversized final results |
