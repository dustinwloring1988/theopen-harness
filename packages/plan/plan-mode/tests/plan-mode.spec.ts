...
import ToolRuntime, { RUN_CODE_NAME, defineContentToolFixture } from '@buckeyestudio/toh-tools'
import { Session, SessionId, type UserMessage } from '@buckeyestudio/toh-session'
import AgentRegistry, { agentEvents, type Agent } from '@buckeyestudio/toh-agent'
...
import { CodeRuntime, type CodeRunRequest, type CodeRunResult } from '@buckeyestudio/toh-code-runtime'
...
/**
 * Drives the REAL plugin: mounts `toh-plan-mode` beside real `SystemPrompt` and
