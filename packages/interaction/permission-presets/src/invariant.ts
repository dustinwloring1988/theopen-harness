/** Package-owned permission-preset event invariants. @module @buckeyestudio/toh-permission-presets/invariant */
...
const PACKAGE_NAME = '@buckeyestudio/toh-permission-presets'
