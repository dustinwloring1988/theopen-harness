/**
 * Package-owned invariant companion for `@buckeyestudio/toh-tool-ask-user`.
 * @module @buckeyestudio/toh-tool-ask-user/invariant
 */
...
const PACKAGE_NAME = '@buckeyestudio/toh-tool-ask-user'
