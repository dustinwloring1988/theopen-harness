/**
 * toh-commands' owned branded id: command lifecycle pairing across the
 * session log, the wire admission response, and client-side flow pairing.
 *
 * The `Branded<B>` primitive lives in `@buckeyestudio/toh-brand`; this module
 ...
 * loading the host plugin's Context merges — the `toh-llm/brand` shape.
 *
 * @module @buckeyestudio/toh-commands/brand
 */
