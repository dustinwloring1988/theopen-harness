...
import { stubSettingsScope, type StubSettingsScope } from '@buckeyestudio/toh-client-test-runtime'
import type { LocaleSettings, LocaleSnapshot } from '@buckeyestudio/toh-client-locale/client'
import { FALLBACK_LOCALE, LocaleRuntime } from '@buckeyestudio/toh-client-locale/client'
 ...
 * `usePinnedBrowserLanguages` (toh-client-test-runtime): they need the shapes
...
describe('LocaleRuntime', () => {
  ...
  it('persists an explicit pick of the provisional locale, so a shared TOH home agrees', () => {
