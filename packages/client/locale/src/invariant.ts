/**
 * Package-owned invariant companion for `@buckeyestudio/toh-client-locale`.
 * @module @buckeyestudio/toh-client-locale/invariant
 */
...
const PACKAGE_NAME = '@buckeyestudio/toh-client-locale'
