/**
 * Package-owned invariant companion for `@buckeyestudio/toh-client-ui-settings-plugins`.
 * @module @buckeyestudio/toh-client-ui-settings-plugins/invariant
 */
...
const PACKAGE_NAME = '@buckeyestudio/toh-client-ui-settings-plugins'
