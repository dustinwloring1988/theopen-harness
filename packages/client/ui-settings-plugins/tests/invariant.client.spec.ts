...
import * as PluginConfigInvariant from '@buckeyestudio/toh-client-ui-settings-plugins/invariant'
...
describe('invariant companion', () => {
  ...
  it('has an empty node half', async () => {
    const { apply } = await import('@buckeyestudio/toh-client-ui-settings-plugins')
