/**
 * Package-owned invariant companion for `@buckeyestudio/toh-client-ui-commands`.
 * @module @buckeyestudio/toh-client-ui-commands/invariant
 */
...
const PACKAGE_NAME = '@buckeyestudio/toh-client-ui-commands'
