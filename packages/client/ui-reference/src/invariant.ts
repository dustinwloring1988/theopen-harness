/**
 * Package-owned invariant companion for `@buckeyestudio/toh-client-ui-reference`.
 * @module @buckeyestudio/toh-client-ui-reference/invariant
 */
...
const PACKAGE_NAME = '@buckeyestudio/toh-client-ui-reference'
