...
import type { SessionProviderComponent, TranslateNS } from '@buckeyestudio/toh-client-ui-slots'
import type { DetailsSlotProps, DetailsToolOwnerProps } from '@buckeyestudio/toh-client-ui-conversation/src/client/contract/slots.ts'
