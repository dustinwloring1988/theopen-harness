...
import type { InjectFace, PropsLocale, PropsRenderSlots, PropsRuntime } from '@buckeyestudio/toh-client-ui-slots'
import type { ToolCallBlock } from '@buckeyestudio/toh-client-runtime/client'
