 ...
 * ({@link module:@buckeyestudio/toh-tools/src/presentation}). This derivation
 ...
 * @module
 */
import type { SearchBlockProps, SearchFileGroup } from '@buckeyestudio/toh-client-ui-primitives'
