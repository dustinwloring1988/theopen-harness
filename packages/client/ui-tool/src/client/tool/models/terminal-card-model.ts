 ...
 * @module
 */
import { resolveWorkspacePath } from '@buckeyestudio/toh-client-runtime/client'
import type { TerminalBlockLabels, TerminalBlockProps } from '@buckeyestudio/toh-client-ui-primitives'
 ...
 * `ToolResultNode.call`/`callView` in toh-client-runtime), leaving a terminal
