/**
 * Package-owned invariant companion for `@buckeyestudio/toh-client-ui-sidebar`.
 * @module @buckeyestudio/toh-client-ui-sidebar/invariant
 */
...
const PACKAGE_NAME = '@buckeyestudio/toh-client-ui-sidebar'
