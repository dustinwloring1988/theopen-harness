 ...
 */
import type { PropsLocale, PropsRenderSlots, PropsRuntime } from '@buckeyestudio/toh-client-ui-slots'
// Type-only: pulls ui-layout's SlotMap merge (the 'sidebar' entry) into every
// program that sees this contract, so PropsRuntime<'sidebar'> resolves.
import type {} from '@buckeyestudio/toh-client-ui-layout/client'
import type { WorkspaceId } from '@buckeyestudio/toh-client-runtime/client'
