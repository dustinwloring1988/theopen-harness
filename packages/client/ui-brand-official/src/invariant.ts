/**
 * Package-owned invariant companion for `@buckeyestudio/toh-client-ui-brand-official`.
 * @module @buckeyestudio/toh-client-ui-brand-official/invariant
 */
...
const PACKAGE_NAME = '@buckeyestudio/toh-client-ui-brand-official'
