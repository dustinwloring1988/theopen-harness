...
import * as ModelsInvariant from '@buckeyestudio/toh-client-ui-settings-models/invariant'
...
describe('invariant companion', () => {
  ...
  it('node-half apply is a no-op host placeholder', async () => {
    const { apply } = await import('@buckeyestudio/toh-client-ui-settings-models')
    apply()
