/**
 * Package-owned invariant companion for `@buckeyestudio/toh-client-ui-settings-models`.
 * @module @buckeyestudio/toh-client-ui-settings-models/invariant
 */
...
const PACKAGE_NAME = '@buckeyestudio/toh-client-ui-settings-models'
