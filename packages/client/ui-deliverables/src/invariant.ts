/**
 * Package-owned invariant companion for `@buckeyestudio/toh-client-ui-deliverables`.
 * @module @buckeyestudio/toh-client-ui-deliverables/invariant
 */
...
const PACKAGE_NAME = '@buckeyestudio/toh-client-ui-deliverables'
