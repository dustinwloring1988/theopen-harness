...
import { apply as applyLocale, inject as localeInject } from '@buckeyestudio/toh-client-locale/client'
import type { ChatFileMentions, TurnTailOwnerProps } from '@buckeyestudio/toh-client-ui-conversation/client'
import { makeTranslate, stubSettingsScope } from '@buckeyestudio/toh-client-test-runtime'
import {
...
describe('package shells', () => {
  it('the invariant companion registers ownership', async () => {
    ...
    expect(registered).toEqual(['@buckeyestudio/toh-client-ui-deliverables'])
