...
const INDIRECTION_PREFIX = '--toh-scrollbar-'
...
const ELEVATED_REBIND = new Map([
  ['--toh-scrollbar-thumb', '--dsw-alias-scrollbar-bg-l2'],
  ['--toh-scrollbar-thumb-hover', '--dsw-alias-scrollbar-hover-l2'],
...
describe('scrollbar.css width variable', () => {
  ...
  it('every reader of the width variable outside ui-theme references a defined variable', () => {
    ...
    // (`right: var(--toh-scrollbar-width)`); a rename in scrollbar.css without
