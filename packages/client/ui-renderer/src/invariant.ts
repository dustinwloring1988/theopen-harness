/**
 * Package-owned invariant companion for `@buckeyestudio/toh-client-ui-renderer`.
 * @module @buckeyestudio/toh-client-ui-renderer/invariant
 */
...
const PACKAGE_NAME = '@buckeyestudio/toh-client-ui-renderer'
