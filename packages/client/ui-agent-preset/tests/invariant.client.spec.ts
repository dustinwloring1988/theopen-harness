...
import * as AgentPresetInvariant from '@buckeyestudio/toh-client-ui-agent-preset/invariant'
...
describe('invariant companion', () => {
  ...
  it('has an empty node half', async () => {
    const { apply } = await import('@buckeyestudio/toh-client-ui-agent-preset')
