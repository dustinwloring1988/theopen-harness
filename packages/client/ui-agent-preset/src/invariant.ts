/**
 * Package-owned invariant companion for `@buckeyestudio/toh-client-ui-agent-preset`.
 * @module @buckeyestudio/toh-client-ui-agent-preset/invariant
 */
...
const PACKAGE_NAME = '@buckeyestudio/toh-client-ui-agent-preset'
