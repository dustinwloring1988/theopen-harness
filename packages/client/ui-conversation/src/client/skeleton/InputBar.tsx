...
import type {} from '@buckeyestudio/toh-plan-mode/client'
// Type-only: the `goal` projection key merge (hint disambiguation).
import type {} from '@buckeyestudio/toh-goal/client'
...
import type { Translate } from '@buckeyestudio/toh-client-ui-slots'
