/**
 * Package-owned invariant companion for `@buckeyestudio/toh-client-ui-skill`.
 * @module @buckeyestudio/toh-client-ui-skill/invariant
 */
...
const PACKAGE_NAME = '@buckeyestudio/toh-client-ui-skill'
