 ...
 * determinism
 * lives host-side — the pre-step boundary (`toh-tool-skill`) recognizes a
...
import type { ConnectionHandle, SessionId, SkillEntry } from '@buckeyestudio/toh-api-remotes/client'
import type { ClientContext, ISessions } from '@buckeyestudio/toh-client-runtime/client'
import type { InputTriggerServiceContract, InputTriggerSource } from '@buckeyestudio/toh-client-ui-input-trigger/client'
...
export function apply(ctx: ClientContext): void {
  ...
  const source: InputTriggerSource = {
    ...
    onPick({ candidate }) {
      ...
      // pre-step boundary (toh-tool-skill) recognizes the leading /name and
