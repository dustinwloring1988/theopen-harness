/**
 * Package-owned invariant companion for `@buckeyestudio/toh-client-connection`.
 * @module @buckeyestudio/toh-client-connection/invariant
 */
...
const PACKAGE_NAME = '@buckeyestudio/toh-client-connection'
