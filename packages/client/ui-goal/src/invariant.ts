/**
 * Package-owned invariant companion for `@buckeyestudio/toh-client-ui-goal`.
 * @module @buckeyestudio/toh-client-ui-goal/invariant
 */
...
const PACKAGE_NAME = '@buckeyestudio/toh-client-ui-goal'
