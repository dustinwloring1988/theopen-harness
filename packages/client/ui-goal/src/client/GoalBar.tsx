...
import type { GoalSnapshot } from '@buckeyestudio/toh-goal/client'
import {
...
import type { PropsLocale } from '@buckeyestudio/toh-client-ui-slots'
...
export type GoalDockProps = import('@buckeyestudio/toh-client-ui-slots').PropsRuntime<'conversation.input.dock'> & GoalBarActions & PropsLocale<'goal'>
