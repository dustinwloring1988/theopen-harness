...
import { ConversationEventRegistry } from '@buckeyestudio/toh-client-runtime/src/client/conversation/event-registry.ts'
import type { GoalProjection } from '@buckeyestudio/toh-goal/client'
