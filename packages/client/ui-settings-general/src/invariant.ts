/**
 * Package-owned invariant companion for `@buckeyestudio/toh-client-ui-settings-general`.
 * @module @buckeyestudio/toh-client-ui-settings-general/invariant
 */
...
const PACKAGE_NAME = '@buckeyestudio/toh-client-ui-settings-general'
