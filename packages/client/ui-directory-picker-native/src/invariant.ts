/**
 * Package-owned invariant companion for `@buckeyestudio/toh-client-ui-directory-picker-native`.
 * @module @buckeyestudio/toh-client-ui-directory-picker-native/invariant
 */
...
const PACKAGE_NAME = '@buckeyestudio/toh-client-ui-directory-picker-native'
