...
import { createScope, scopeOf, SlotRegistry } from '@buckeyestudio/toh-client-runtime/client'
import type { SessionId } from '@buckeyestudio/toh-client-runtime/client'
import { apply, inject, InputTriggerService } from '@buckeyestudio/toh-client-ui-input-trigger/client'
import type { MenuViewInjected } from '@buckeyestudio/toh-client-ui-input-trigger/client'
