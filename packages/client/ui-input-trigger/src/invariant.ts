/**
 * Package-owned invariant companion for `@buckeyestudio/toh-client-ui-input-trigger`.
 * @module @buckeyestudio/toh-client-ui-input-trigger/invariant
 */
...
const PACKAGE_NAME = '@buckeyestudio/toh-client-ui-input-trigger'
