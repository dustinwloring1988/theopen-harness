/**
 * Package-owned invariant companion for `@buckeyestudio/toh-client-runtime`.
 * @module @buckeyestudio/toh-client-runtime/invariant
 */
...
import type { SlotMap } from '@buckeyestudio/toh-client-ui-slots'
import type { InvariantInstaller } from '@buckeyestudio/toh-invariants'

const PACKAGE_NAME = '@buckeyestudio/toh-client-runtime'
