 ...
 * Agent's identity. The mechanism mirrors the host `toh-scope` architecture
...
import type { SessionId } from '@buckeyestudio/toh-api-remotes/client'
import type { TypertClientRemote, TypertRemoteScopeApi } from '@buckeyestudio/toh-typert-protocol'
...
const kScope = Symbol('toh.client.scope')
