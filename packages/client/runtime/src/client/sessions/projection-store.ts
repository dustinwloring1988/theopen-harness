...
// (`/types`, zero imports), never the package root: the root's toh-agent →
// toh-session chain would drag the host `Context.sessions` merge into the
...
export type { SessionProjectionMap } from '@buckeyestudio/toh-session-projection/types'
