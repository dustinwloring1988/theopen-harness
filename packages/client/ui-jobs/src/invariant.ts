/**
 * Package-owned invariant companion for `@buckeyestudio/toh-client-ui-jobs`.
 * @module @buckeyestudio/toh-client-ui-jobs/invariant
 */
...
const PACKAGE_NAME = '@buckeyestudio/toh-client-ui-jobs'
