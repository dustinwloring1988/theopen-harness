/**
 * Package-owned invariant companion for `@buckeyestudio/toh-client-ui-message-feedback`.
 * @module @buckeyestudio/toh-client-ui-message-feedback/invariant
 */
...
const PACKAGE_NAME = '@buckeyestudio/toh-client-ui-message-feedback'
