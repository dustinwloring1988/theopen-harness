/**
 * Package-owned invariant companion for `@buckeyestudio/toh-client-ui-layout`.
 * @module @buckeyestudio/toh-client-ui-layout/invariant
 */
...
const PACKAGE_NAME = '@buckeyestudio/toh-client-ui-layout'
