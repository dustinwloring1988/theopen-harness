 ...
 * not built (`pnpm --filter @buckeyestudio/toh-client-ui-trajectory bundle`).
 */
...
const PLUGIN_ID = '@buckeyestudio/toh-client-ui-trajectory'
...
describe('tsdown client artifact', () => {
  ...
  async function loadArtifact() {
    ...
    const modules = new Map<string, unknown>([
      ...
      ['@buckeyestudio/toh-client-runtime/client', await import('@buckeyestudio/toh-client-runtime/client')],
      ['@buckeyestudio/toh-client-ui-primitives', await import('@buckeyestudio/toh-client-ui-primitives')],
    ])
  ...
  it.skipIf(code === undefined)('mounted as an object plugin, apply registers the view tab on the real ring', async () => {
    ...
    const locale = await import('@buckeyestudio/toh-client-locale/client')
