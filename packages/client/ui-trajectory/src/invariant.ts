/**
 * Package-owned invariant companion for `@buckeyestudio/toh-client-ui-trajectory`.
 * @module @buckeyestudio/toh-client-ui-trajectory/invariant
 */
...
const PACKAGE_NAME = '@buckeyestudio/toh-client-ui-trajectory'
