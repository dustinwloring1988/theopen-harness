/**
 * Package-owned invariant companion for `@buckeyestudio/toh-client-ui-primitives`.
 * @module @buckeyestudio/toh-client-ui-primitives/invariant
 */
...
const PACKAGE_NAME = '@buckeyestudio/toh-client-ui-primitives'
