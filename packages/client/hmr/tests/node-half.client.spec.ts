...
import type { WebBootGraph, ClientModuleRegistry } from '@buckeyestudio/toh-client-modules'
import type { WebRoute, WebServer } from '@buckeyestudio/toh-host-webserver'
...
beforeEach(() => { dir = mkdtempSync(join(tmpdir(), 'toh-hmr-')) })
