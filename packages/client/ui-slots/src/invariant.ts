/**
 * Package-owned invariant companion for `@buckeyestudio/toh-client-ui-slots`.
 * @module @buckeyestudio/toh-client-ui-slots/invariant
 */
...
const PACKAGE_NAME = '@buckeyestudio/toh-client-ui-slots'
