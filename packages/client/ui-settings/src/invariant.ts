/**
 * Package-owned invariant companion for `@buckeyestudio/toh-client-ui-settings`.
 * @module @buckeyestudio/toh-client-ui-settings/invariant
 */
...
const PACKAGE_NAME = '@buckeyestudio/toh-client-ui-settings'
