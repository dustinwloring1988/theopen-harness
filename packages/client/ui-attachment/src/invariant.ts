/**
 * Package-owned invariant companion for `@buckeyestudio/toh-client-ui-attachment`.
 * @module @buckeyestudio/toh-client-ui-attachment/invariant
 */
...
const PACKAGE_NAME = '@buckeyestudio/toh-client-ui-attachment'
