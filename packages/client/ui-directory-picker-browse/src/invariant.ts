/**
 * Package-owned invariant companion for `@buckeyestudio/toh-client-ui-directory-picker-browse`.
 * @module @buckeyestudio/toh-client-ui-directory-picker-browse/invariant
 */
...
const PACKAGE_NAME = '@buckeyestudio/toh-client-ui-directory-picker-browse'
