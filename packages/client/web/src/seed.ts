...
import * as Cordis from '@buckeyestudio/cordis'
import * as UiSlots from '@buckeyestudio/toh-client-ui-slots'
import * as UiPrimitives from '@buckeyestudio/toh-client-ui-primitives'
...
export function getStaticModules(): Record<string, unknown> {
  ...
  return {
    ...
    '@buckeyestudio/cordis': Cordis,
    '@buckeyestudio/toh-client-ui-slots': UiSlots,
    '@buckeyestudio/toh-client-ui-primitives': UiPrimitives,
