 ...
 * @module @buckeyestudio/toh-client-web/src/boot-page
 */
...
export class BootPage {
  ...
  constructor(container: HTMLElement) {
    ...
    this.root.dataset.tohBoot = ''
    this.card = div(css.card)
    this.wordmark = div(css.wordmark, 'HARNESS')
    this.spinner = div(css.spinner)
    this.spinner.dataset.tohBootSpinner = ''
  ...
  private updateProgress(): void {
    ...
    this.spinner.style.setProperty('--toh-boot-arc', `${String(Math.round(72 + ratio * 216))}deg`)
  }
}
