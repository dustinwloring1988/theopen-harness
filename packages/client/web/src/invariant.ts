/**
 * Package-owned invariant companion for `@buckeyestudio/toh-client-web`.
 * @module @buckeyestudio/toh-client-web/invariant
 */
...
const PACKAGE_NAME = '@buckeyestudio/toh-client-web'
