 ...
 * @module @buckeyestudio/toh-client-web/src/loader-status
 */
import type { FiberState } from '@buckeyestudio/cordis'
 ...
 * while retaining its type (same rationale as toh-tool-cordis's mirror).
 */
