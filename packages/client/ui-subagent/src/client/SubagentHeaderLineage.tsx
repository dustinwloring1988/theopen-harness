...
import type {} from '@buckeyestudio/toh-subagent/client'
import type {} from '@buckeyestudio/toh-token-meter/client'
...
function CatalogDropdown({
  ...
  const requestedInitialCatalog = useRef<SessionId | undefined>(undefined)
