/**
 * Package-owned invariant companion for `@buckeyestudio/toh-client-ui-subagent`.
 * @module @buckeyestudio/toh-client-ui-subagent/invariant
 */
...
const PACKAGE_NAME = '@buckeyestudio/toh-client-ui-subagent'
