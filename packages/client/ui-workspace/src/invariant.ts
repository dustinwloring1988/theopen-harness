/**
 * Package-owned invariant companion for `@buckeyestudio/toh-client-ui-workspace`.
 * @module @buckeyestudio/toh-client-ui-workspace/invariant
 */
...
const PACKAGE_NAME = '@buckeyestudio/toh-client-ui-workspace'
