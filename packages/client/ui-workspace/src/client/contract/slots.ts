 ...
 */
import type { HostDescriptionSource } from '@buckeyestudio/toh-client-connection/client'
import type { HostObservable, PropsHooks, PropsLocale, PropsRenderSlots, PropsRuntime, PropsStore } from '@buckeyestudio/toh-client-ui-slots'
// Type-only: pull the owner SlotMap merges into programs that resolve the
// runtime shares below.
import type {} from '@buckeyestudio/toh-client-ui-sidebar/client'
