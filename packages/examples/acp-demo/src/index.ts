 ...
 * ({@link @buckeyestudio/toh-agent-spine-demo}), JSONL session persistence, and
 * the {@link @buckeyestudio/toh-acp} bridge. The app owns those plugins through one
 ...
 * @module @buckeyestudio/toh-acp-demo
 */

import type { Context } from '@buckeyestudio/cordis'
import { join } from 'node:path'
import z from '@buckeyestudio/schemastery'
import * as acp from '@buckeyestudio/toh-acp'
...
} from '@buckeyestudio/toh-session-persistence-jsonl'
import * as sessionCheckpointPolicy from '@buckeyestudio/toh-session-checkpoint-policy'
...
export const Config: z<Config> = z.object({
  ...
  // order" (the owning toh-system-prompt schema does the same), while
