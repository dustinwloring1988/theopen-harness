/**
 * Package-owned invariant companion for `@buckeyestudio/toh-acp-demo`.
 * @module @buckeyestudio/toh-acp-demo/invariant
 */
...
const PACKAGE_NAME = '@buckeyestudio/toh-acp-demo'
