/**
 * Package-owned invariant companion for `@buckeyestudio/toh-sdk-jsonrpc-demo`.
 * @module @buckeyestudio/toh-sdk-jsonrpc-demo/invariant
 */
...
const PACKAGE_NAME = '@buckeyestudio/toh-sdk-jsonrpc-demo'
