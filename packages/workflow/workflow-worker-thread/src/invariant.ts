/**
 * Package-owned invariant companion for `@buckeyestudio/toh-workflow-worker-thread`.
 * @module @buckeyestudio/toh-workflow-worker-thread/invariant
 */
...
const PACKAGE_NAME = '@buckeyestudio/toh-workflow-worker-thread'
