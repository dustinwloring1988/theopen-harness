 ...
 * @module @buckeyestudio/toh-workflow-worker-thread/protocol
 */

import type { WorkflowAgentEndInfo, WorkflowAgentInfo, WorkflowResult } from '@buckeyestudio/toh-workflow'
