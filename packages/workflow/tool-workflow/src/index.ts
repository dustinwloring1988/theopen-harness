 ...
 * (`@buckeyestudio/toh-workflow`), so a hardened engine swaps in without touching what the model
 ...
 * @module @buckeyestudio/toh-tool-workflow
 */

import type { Context } from '@buckeyestudio/cordis'
import z from '@buckeyestudio/schemastery'
import { defineTool } from '@buckeyestudio/toh-tools'
import type { ToolCallView, ToolResultView } from '@buckeyestudio/toh-tools'
import type { ContentBlock } from '@buckeyestudio/toh-llm'
import type { JsonValue, Session, SessionEventMap } from '@buckeyestudio/toh-session'
import type {
  WorkflowResult, WorkflowRun, WorkflowRunId, WorkflowStopReason,
} from '@buckeyestudio/toh-workflow'
import type {
