/**
 * Package-owned invariant companion for `@buckeyestudio/toh-tool-ralph`.
 * @module @buckeyestudio/toh-tool-ralph/invariant
 */
...
const PACKAGE_NAME = '@buckeyestudio/toh-tool-ralph'
