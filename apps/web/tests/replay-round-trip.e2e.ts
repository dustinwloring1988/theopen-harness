...
// in the temp workspace) all run; the model adapter is toh-llm-replay (keyless)
...
// Record: TOH_SNAPSHOT=record rewrites session.jsonl, then a keyless
// TOH_SNAPSHOT=refresh regenerates ui.expected.md.
