...
import type {} from '@buckeyestudio/toh-goal'
import {
...
const PACKAGE_FILES: Readonly<Record<string, string>> = {
  ...
  'packages/client/ui-conversation/package.json': '{"name":"@buckeyestudio/toh-client-ui-conversation"}\n',
  ...
  'packages/context/session-reference/package.json': '{"name":"@buckeyestudio/toh-session-reference"}\n',
  ...
  'packages/llm/token-meter/package.json': '{"name":"@buckeyestudio/toh-token-meter"}\n',
  ...
  'packages/skill/skill-filesystem/package.json': '{"name":"@buckeyestudio/toh-skill-filesystem"}\n',
