...
// regression the external report asked for (toh-external/issues#107 →
// theopen-harness#1406): "increase an 800×720 browser regression test and
...
import type {} from '@buckeyestudio/toh-plan-mode'
