...
it('boots the built plugin graph and renders a fixture session end to end', async () => {
  ...
  expect(screen.queryByText('TOH Local Build')).toBeNull()
  ...
  for (const plugin of ['@buckeyestudio/toh-client-ui-layout', '@buckeyestudio/toh-client-ui-sidebar', '@buckeyestudio/toh-client-ui-conversation', '@buckeyestudio/toh-client-ui-tool']) {
