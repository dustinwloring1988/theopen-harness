...
Python packages for driving TheOpen Harness as a subprocess. The client SDK communicates with the bundled runtime over newline-delimited JSON-RPC on stdio.

## Packages

| Directory | Dist / module | Role |
|---|---|---|
| [sdk](sdk/README.md) | `theopen-harness-sdk` / `theopen_harness` | High-level turns API and lower-level JSON-RPC client |
| [sdk-runtime](sdk-runtime/README.md) | `theopen-harness-runtime-bin` / `theopen_harness_runtime` | Bundled runtime binaries and default agent configuration |
