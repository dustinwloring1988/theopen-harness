import { EntryGroup, EntryTree, isJsExpr, type EntryOptions } from '@buckeyestudio/cordis-plugin-loader'
 ...
 * (`toh --dump-config`) parses and prints exactly the dialect this include
 * mounts.
 */
 ...
 * (`toh --dump-config`) so a dump can never drift from what boots. The input
