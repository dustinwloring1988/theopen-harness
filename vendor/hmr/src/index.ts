import { Context, Service, type Plugin } from '@buckeyestudio/cordis'
import type { Dict } from '@buckeyestudio/cosmokit'
import { ModuleLoader, type ModuleJob, type ResolveResult } from '@buckeyestudio/cordis-plugin-loader'
...
import type {} from '@buckeyestudio/cordis-plugin-timer'
...
namespace Hmr {
  ...
  // [theopen-harness] vendored modification: removed `.i18n({ 'en-US': enUS, 'zh-CN': zhCN })`
